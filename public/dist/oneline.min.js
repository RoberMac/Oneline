...
angular.module("Oneline.olControlCenterDirectives",[]).directive("replicantDeckard",["Replicant",function(e){return{restrict:"A",link:function(t,r,a){function n(){i=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));r.html(e.substr(0,7))},100);var a=[];t.providerList.forEach(function(e){var t=JSON.parse(localStorage.getItem("profile_"+e));t&&a.push(t)}),e.deckard({profileList:JSON.stringify(a)}).$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(i),r.html(e.code)},700),o=setInterval(function(){return 0>t?(n(),r.attr("data-countdown",""),void clearInterval(o)):void r.attr("data-countdown",t--)},1e3)},function(e){clearInterval(i)})}var i,o;r.on("$destroy",function(){clearInterval(i),clearInterval(o)}),n()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(e,t){return{restrict:"A",link:function(r,a,n){a.on("submit",function(n){n.preventDefault();var i=a.children(),o=i.val();i[0].blur(),e.rachael({code:o}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),r.updateProviderList(),e.profileList.forEach(function(e){localStorage.setItem("profile_"+e._provider,JSON.stringify(e))})),r.setControlCenter("")},function(e){i.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("read",[function(){return{restrict:"A",controller:["$scope","Action",function(e,t){var r=e.controlCenter.split(":"),a=r[1],n=r[0].split("-")[0].split("_")[1],i=r[0].split("-")[1];t.get({action:i,provider:n,id:a}).$promise.then(function(t){e.readType=i,e.readItems=t.data})["catch"](function(){angular.element(document.querySelector(".read .loadMore")).addClass("loadMore--loading--fail")})}]}}]).directive("write",["$compile","$templateRequest","$filter","Action","olUI",function(e,t,r,a,n){return{restrict:"A",scope:!1,link:function(i,o,l){var d,c=i.controlCenter.split(":"),s=c[1],p=c[0].split("-")[0].split("_")[1],u=c[0].split("-")[1],m="",f="tweet"===u||"reply"===u||"weibo"===p?140:"retweet"===u?116:null,v=o.find("button"),w=v.eq(v.length-1),g=o.find("textarea"),_=document.querySelector(".cancelMask__wrapper"),h=angular.element(_);if("reply"===u||"retweet"===u)"twitter"===p&&"reply"===u?g.val("@"+c[2]+" "):"retweet"===u&&(g.prop("required",!1),w.prop("disabled",!1)),h.children().append(angular.element(document.querySelector('[data-id="'+s+'"]')).clone().removeClass("divider--top divider--bottom")),angular.element(_.querySelectorAll("button.tips--deep")).addClass("tips--frozen"),angular.element(_.querySelector("[data-source]")).parent().removeClass("tips--frozen"),d=angular.element(_.querySelector("[data-"+u+"]")),d.parent().removeClass("tips--deep tips--frozen");else if("tweet"===u){var y=JSON.parse(localStorage.getItem("profile_"+p))||{};i.tweetPreview={user:{name:y.displayName,avatar:y.avatar,screen_name:y.screen_name},media:[],text:"",created_at:Date.now()},t("controlCenter/write/component/livePreview--"+p+".html").then(function(t){h.children().append(e(t)(i))})}var C="";o.on("submit",function(e){e.preventDefault();var t={status:C};"twitter"===p?(angular.extend(t,{geo:o.find("geo-picker").data("geo"),media_ids:o.find("media-upload").data("media_ids")}),"retweet"===u&&C.length>0&&(m="quote",t.status=C+" https://twitter.com/"+c[2]+"/status/"+s)):"weibo"===p&&"tweet"===u&&angular.extend(t,{geo:o.find("geo-picker").data("geo")}),g.prop("disabled",!0),w.addClass("write__btn--send--sending"),a.update({action:m||u,provider:p,id:s||0},{params:t}).$promise.then(function(e){if("retweet"===u)if(n.setActionState("retweet",s,"active"),n.actionData("retweet",s,e.id_str),"quote"===m)n.setActionState("retweet",s,"frozen");else{var t=~~n.actionData("retweet",s,null,"count")+1;n.actionData("retweet",s,t,"count")}i.setControlCenter("")})["catch"](function(){w.prop("disabled",!1),g.addClassTemporarily("write__textarea--err",500)})["finally"](function(){g.prop("disabled",!1),w.removeClass("write__btn--send--sending")})}).on("input",function(){C=g.val().trim(),i.tweetPreview&&(i.tweetPreview.text=r("linkify")(C,p),i.$apply());var e=C.length;e>f||0===e?w.prop("disabled",!0):w.prop("disabled",!1),w.attr("data-count",e>0?e:""),w.addClassTemporarily("write__btn--send--typing",700),d?d.addClassTemporarily("actions__button--"+u+"--active",300):null}).on("$destroy",function(){o.off()})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/geoPicker.html",link:function(t,r,a){var n=r.find("button");n.on("click",function(){n.hasClass("tips--active")?(r.removeData("geo"),n.removeClass("tips--active tips--inprocess")):(n.addClass("tips--inprocess"),e.navigator.geolocation.getCurrentPosition(function(e){r.data("geo",{lat:e.coords.latitude,"long":e.coords.longitude}),n.addClass("tips--active"),n.removeClass("tips--inprocess")},function(e){n.removeClass("tips--inprocess"),n.addClassTemporarily("tips--error",500)},{maximumAge:6e4,timeout:7e3}))}),n.on("$destroy",function(){n.off("click")})}}}]).directive("mediaUpload",["Media",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/mediaUpload.html",link:function(t,r,a){function n(e,a){var n=new FileReader;n.onload=function(e){var r=angular.element(document.querySelectorAll(".write__previews")),n=URL.createObjectURL(l(e.target.result)),i='<span class="write__previews__item tips--active tips--inprocess animate--faster" data-mediaId><img src="'+n+'"></span>';r.append(i);var o=document.querySelectorAll(".write__previews__item"),d=angular.element(o[o.length-1]);d.attr("data-mediaId",a),t.tweetPreview&&(t.tweetPreview.media.push({type:"photo",image_url:n,fakeId:a}),t.$apply())},n.readAsDataURL(e),3===document.querySelectorAll(".write__previews__item").length&&r.css("display","none")}function i(e){var r=document.querySelector('[data-mediaId="'+e+'"]');angular.element(r).remove(),t.tweetPreview&&(t.tweetPreview.media=t.tweetPreview.media.filter(function(t){return t.fakeId!==e}),t.$apply())}function o(e,a){var n=angular.element(document.querySelector('[data-mediaId="'+e+'"]'));n.removeClass("tips--inprocess").attr("data-mediaId",a).on("click",function(){var e=r.data("media_ids")||[],a=n.attr("data-mediaId"),i=e.indexOf(a);e.splice(i,1),e.length<=0?r.removeData("media_ids"):r.data("media_ids",e),n.remove(),t.tweetPreview&&(t.tweetPreview.media.splice(i,1),t.$apply()),document.querySelectorAll(".write__previews__item").length<4&&r.attr("style","")}).on("$destroy",function(){n.off("click")})}function l(e){var t=";base64,";if(-1==e.indexOf(t)){var r=e.split(","),a=r[0].split(":")[1],n=decodeURIComponent(r[1]);return new Blob([n],{type:a})}for(var r=e.split(t),a=r[0].split(":")[1],n=window.atob(r[1]),i=n.length,o=new Uint8Array(i),l=0;i>l;++l)o[l]=n.charCodeAt(l);return new Blob([o],{type:a})}var d=a.provider,c=r.find("input");c.on("change",function(){var t=new FormData,a=c[0].files[0],l=Date.now();n(a,l),t.append("twitterMedia",a),e.upload({provider:d},t).$promise.then(function(e){var t=r.data("media_ids")||[],a=e.media_id;t.push(a),r.data("media_ids",t),o(l,a)})["catch"](function(e){i(l)}),c[0].value=""}),c.on("$destroy",function(){c.off("change")})}}}]);
