...
angular.module("Oneline.maskDirectives",[]).directive("showMenu",["olMask",function(t){return{restrict:"A",link:function(n,i,o){i.on("click",function(){var i=o.showMenu;t["switch"](n).then(function(){t.append("mask/menu/"+i+".html",n)})}).on("$destroy",function(){i.off()})}}}]).directive("userProfile",["Action","store","olMask","olUserProfile",function(t,n,i,o){return{restrict:"A",link:function(e,a,l){a.on("click",function(){function c(){e.loadState="initLoad",e.user={screen_name:s.screen_name,avatar:s.avatar,name:s.name,uid:s.uid},e.loadUserTimeline=function(){"loading"!==e.loadState&&(e.loadState="loading",o.loadOldPosts(r,s.uid).then(function(t){e.user.timeline=e.user.timeline.concat(t),e.loadState="loadFin"})["catch"](function(t){e.loadState="loadFail"}))},i.append("mask/user/"+r+".html",e),"controlCenter"===d?a.addClass("timeline__media--loading"):null,t.get({action:"weibo"===r&&e._profile?"user_in_tweet":"user",provider:r,id:"weibo"===r&&e._profile?e._id_str:s.uid}).$promise.then(function(t){angular.extend(e.user,t.data),e.loadState="loadFin","controlCenter"===d?a.addClass("timeline__media--active"):null})["catch"](function(){e.user["protected"]=!0,e.loadState="loadFail","controlCenter"===d?a.addClass("tips--frozen"):null})["finally"](function(){"controlCenter"===d?a.removeClass("timeline__media--loading"):null})}var r=l.userProfile.split(":")[0],d=l.userProfile.split(":")[1],s=e._profile||n.get("profile_"+r);"controlCenter"===d&&a.hasClass("tips--frozen")||("timeline"===d?i["switch"](e).then(function(){c()}):c())}).on("$destroy",function(){a.off("click")})}}}]).directive("toggleFollowing",["Action",function(t){return{restrict:"A",link:function(n,i,o){i.on("click",function(){var n=angular.element(document.querySelectorAll(".profile__count__column")[1]),e=o.toggleFollowing.split(":"),a=e[0],l=e[1],c=i.hasClass("icon--"+a);i.addClass("tips--inprocess"),t[c?"destroy":"create"]({action:"follow",provider:a,id:l}).$promise.then(function(t){i.toggleClass("tips--active icon--"+a);var o=~~n.attr("data-count")+(c?-1:1);n.attr("data-count",o)})["catch"](function(t){i.addClassTemporarily("tips--error",500)})["finally"](function(){i.removeClass("tips--inprocess")})})}}}]).directive("location",["Action","olMask",function(t,n){return{restrict:"A",link:function(i,o,e){o.on("click",function(){function o(){i.loadState="initLoad",i.location={name:a.name},n.append("mask/location/"+l+".html",i),t.get({action:"location_timeline",provider:l,id:a.id||0,lat:a.lat,"long":a["long"]}).$promise.then(function(t){i.location.timeline=t.data,i.loadState="loadFin"})["catch"](function(){i.loadState="loadFail"})}var a=i._location,l=e.location;n["switch"](i).then(function(){o()})}).on("$destroy",function(){o.off("click")})}}}]).directive("mentions",["$timeout","olNotification",function(t,n){return{restrict:"E",scope:{},templateUrl:"mask/notification/mentions/twitter.html",controller:["$scope","$element",function(i,o){var e,a=o.attr("provider");i.notifications=[],i.loadState="initLoad",e=n.initLoad(a,"mentions"),e&&e.length>0?t(function(){i.notifications=e,i.loadState="loadFin"},700):n.load(!0).then(function(t){i.notifications=t,i.loadState="loadFin"})["catch"](function(t){i.loadState="loadFail"}),i.loadMentions=function(t){"loading"!==i.loadState&&(i.loadState="loading",n.load(!1).then(function(t){i.notifications=t,i.loadState="loadFin"})["catch"](function(t){i.loadState="loadFail"}))}}]}}]).directive("direct",["$timeout","$filter","olNotification",function(t,n,i){return{restrict:"E",scope:{},templateUrl:"mask/notification/direct/twitter.html",controller:["$scope","$element","store",function(n,o,e){function a(){var t=i.extractDirect(u);t[0].length>0&&Object.keys(t[1]).length>0&&(n.senderList=t[0],r=t[1],n.showDirect(d||n.senderList[0].uid)),n.loadState="loadFin"}function l(i){n.notifications=r[i],t(function(){var t=angular.element(document.querySelector('[js-direct-sender="'+i+'"]'));t.parent().children().removeClass("tips--active--peace"),t.addClass("tips--active--peace");var n=document.querySelector(".mask__notification");n.scrollTop=n.scrollHeight})}var c,r,d,s=o.attr("provider"),u=e.get("profile_"+s).uid;n.notifications=[],n.senderList=[],n._authUid=u,n.loadState="initLoad",c=i.initLoad(s,"direct"),c&&c.length>0?t(function(){a()},700):i.load(!0).then(function(t){a()})["catch"](function(t){n.loadState="loadFail"}),n.loadDirect=function(t){"loading"!==n.loadState&&(n.loadState="loading",i.load(!1).then(function(t){a()})["catch"](function(t){n.loadState="loadFail"}))},n.showDirect=function(i){d===i?l(i):(n.notifications=[],t(function(){l(i)},350)),d=i}}]}}]);
angular.module("Oneline.mediaDirectives",[]).directive("olVideo",function(){return{restrict:"E",scope:{olPoster:"@",olSrc:"@"},templateUrl:"media/video.html",link:function(e,t,n){var i=t.children()[0],a=angular.element(t.children()[1]);i.setAttribute("src",e.olSrc),t.on("click",function(){i.paused?i.play():i.pause(),a.toggleClass("timeline__media__playButton--playing"),t.on("mouseout",function(){i.removeAttribute("loop")})}).on("$destroy",function(){t.off()}),angular.element(i).on("ended",function(){a.removeClass("timeline__media__playButton--playing")})}}}).directive("olImageThumb",function(){return{restrict:"A",link:function(e,t,n){t.on("click",function(){var e=t.parent(),i=e.next(),a=e.children(),r=i.find("img"),o=i.find("a");if(a.removeClass("timeline__media--active").addClass("timeline__media--inactive"),t.addClass("timeline__media--active timeline__media--loading"),e.addClass("timeline__media--small"),i.removeClass("timeline__media--hide"),r.attr("src",n.src.replace(/square|small/,"bmiddle")),o.attr("href",n.src.replace(/square|small/,"large")),r.on("load",function(){1===a.length?t.parent().remove():null,t.removeClass("timeline__media--loading"),r.off("load")}),!r.data("urlList")){var l=Array.prototype.map.call(a,function(e){return angular.element(e).attr("src").replace(/square|small/,"bmiddle")});r.data("urlList",l)}}).on("$destroy",function(){t.off()})}}}).directive("selectImage",function(){return{restrict:"A",link:function(e,t,n){n.imageCount>1&&t.on("mousemove",function(e){e.offsetX-t[0].offsetWidth/2>0?(t.removeClass("cursor--pre"),t.addClass("cursor--next")):(t.removeClass("cursor--next"),t.addClass("cursor--pre"))}).on("click",function(){var e=t.find("img"),n=e.data("urlList")||[],i=n.indexOf(e.attr("src")),a=t.hasClass("cursor--next")?i+1:i-1;if(!(0>a||a>n.length-1)){var r=angular.element(angular.element(t.parent().children()[0]).children()),o=angular.element(r[a]);r.removeClass("timeline__media--active timeline__media--loading"),o.addClass("timeline__media--active timeline__media--loading"),e.on("load",function(){o.removeClass("timeline__media--loading"),e.off("load")}).attr("src",n[a]).next().attr("href",n[a].replace("bmiddle","large"))}}).on("$destroy",function(){t.off()})}}}).directive("handleImageError",function(){return{restrict:"A",link:function(e,t,n){t.on("error",function(){""!==t.attr("src")&&t.attr("src",'data:image/svg+xml;utf8,<svg viewBox="0 0 529 530" xmlns="http://www.w3.org/2000/svg"><g fill="none"><path d="M51.245 150.775c-3.454-1.729-5.458-.098-4.476 3.638l.706 2.688c8.01 30.498-2.986 73.86-24.566 96.854l-.662.706c-2.643 2.816-1.649 5.288 2.193 5.52l136.636 8.237c9.376.565 23.953-2.031 32.554-5.798l21.279-9.319-13.768-18.801c-5.55-7.579-16.851-17.127-25.254-21.333l-124.642-62.392z" fill="#000"/><path d="M9.298 290.938c13.001 129.203 122.073 230.062 254.702 230.062 141.385 0 256-114.615 256-256s-114.615-256-256-256c-84.794 0-159.96 41.226-206.547 104.728" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/><path d="M361.259 190.733c-4.06-1.129-8.339-1.733-12.759-1.733-26.234 0-47.5 21.266-47.5 47.5 0 4.115.523 8.109 1.507 11.917" stroke="#000" stroke-width="17" stroke-linecap="round"/><path d="M213.468 406.97c13.141-16.776 37.347-28.026 65.032-28.026 30.37 0 56.552 13.538 68.536 33.056" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/></g></svg>')})}}}).directive("olLazyImage",function(){return{restrict:"A",scope:{ratio:"@olLazyImage"},link:function(e,t,n){var i=e.ratio;t.css("padding-bottom",100*i+"%")}}}).directive("usersInPhoto",function(){return{restrict:"A",scope:{usersInPhoto:"="},link:function(e,t,n){function i(e,t,n,i){var r,o,l;return e>.5?(r=(1-e)*n,t>.5?(o=(1-t)*i,l=a(o/r)+90):(o=t*i,l=a(r/o))):(r=e*n,t>.5?(o=(1-t)*i,l=a(r/o)+180):(o=t*i,l=-a(o/r))),l}function a(e){return 180*Math.atan(e)/Math.PI}var r=e.usersInPhoto;t.on("click",function(){var e=t.parent().find("span"),n=t.parent().parent()[0];t.hasClass("tips--active--peace")?(t.removeClass("tips--active--peace"),e.parent().removeClass("timeline__media__userTag--show")):(t.addClass("tips--active--peace"),r.forEach(function(t,a){var r=angular.element(e[a]),o=n.offsetWidth,l=n.offsetHeight,s=t.position.x,c=t.position.y,d=i(s,c,o,l);r.children().css({transform:"rotate("+-d+"deg)"}),r.parent().css({top:100*c+"%",left:"calc("+100*s+"% - 16px)",transform:"rotate(0deg)"}).addClass("timeline__media__userTag--show").addClassTemporarily("timeline__media__userTag--popup",700).delay(777).then(function(e){e.css("transform","rotate("+d+"deg)")})}))}).on("$destroy",function(){t.off()})}}});
...
angular.module("Oneline.maskServices",[]).service("olMask",["$timeout","$compile","$templateRequest",function(e,t,n){this.append=function(i,r){e(function(){var e=angular.element(document.querySelector(".cancelMask__wrapper"));n(i,r).then(function(n){e.children().empty().append(t(n)(r))})})},this["switch"]=function(e){return e.controlCenter?e.setControlCenter("","fullmask"):e.setControlCenter("fullmask")}}]).service("olUserProfile",["$q","Action",function(e,t){this.loadOldPosts=function(n,i){var r=e.defer(),o=document.querySelectorAll(".profile .timeline"),a=angular.element(o[o.length-1]).attr("data-id");return t.get({action:"user_timeline",provider:n,id:i,max_id:a}).$promise.then(function(e){r.resolve(e.data.data)})["catch"](function(e){r.reject(e)}),r.promise}}]).service("olNotification",["$q","$filter","store","Action",function(e,t,n,i){function r(e,n){return t("orderBy")(t("filter")(u,function(t,i,r){return t.sender.uid===e||t.sender.uid===n&&t.recipient.uid===e}),"created_at")}var o,a,c,u,d;this.initLoad=function(e,t){return o=e,a=t,c="mentions"===t?"notification_m_"+e:"notification_d_"+e,_info=n.get(c)||{},u=_info.notifications||[],d=_info.max_id,u},this.load=function(t){var r=e.defer();return i.get({action:a,provider:o,id:0,min_id:t?null:d}).$promise.then(function(e){e=e.data,d=e.max_id||d,e.data.length>0&&(u=u.concat(e.data),n.set(c,{notifications:u,max_id:d})),r.resolve(u)})["catch"](function(e){r.reject(e)}),r.promise},this.extractDirect=function(e){for(var t=[],n={},i=[],o=0,a=u.length;a>o;o++){var c=u[o].sender;c.uid!==e&&i.indexOf(c.uid)<0&&(t.push(u[o].sender),i.push(c.uid))}if(1===t.length){var d=t[0].uid;n[d]=r(d,e)}else t=t.sort(function(t,i){var o=t.uid,a=i.uid,c=r(o,e),u=r(a,e);n[o]=c,n[a]=u;var d=c[c.length-1].created_at;return latestCreatedAt2=u[u.length-1].created_at,d<latestCreatedAt2});return[t,n]}}]);
