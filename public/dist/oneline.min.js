...
angular.module("Oneline.olControlCenterDirectives",[]).directive("replicantDeckard",["Replicant",function(e){return{restrict:"A",link:function(t,n,r){function a(){i=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));n.html(e.substr(0,7))},100);var r=[];t.providerList.forEach(function(e){var t=JSON.parse(localStorage.getItem("profile_"+e));t&&r.push(t)}),e.deckard({profileList:JSON.stringify(r)}).$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(i),n.html(e.code)},700),o=setInterval(function(){return 0>t?(a(),n.attr("data-countdown",""),void clearInterval(o)):void n.attr("data-countdown",t--)},1e3)},function(e){clearInterval(i)})}var i,o;n.on("$destroy",function(){clearInterval(i),clearInterval(o)}),a()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(e,t){return{restrict:"A",link:function(n,r,a){r.on("submit",function(a){a.preventDefault();var i=r.children(),o=i.val();i[0].blur(),e.rachael({code:o}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),n.updateProviderList(),e.profileList.forEach(function(e){localStorage.setItem("profile_"+e._provider,JSON.stringify(e))})),n.setControlCenter("")},function(e){i.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("read",[function(){return{restrict:"A",controller:["$scope","Action",function(e,t){var n=e.controlCenter.split(":"),r=n[1],a=n[0].split("-")[0].split("_")[1],i=n[0].split("-")[1];t.get({action:i,provider:a,id:r}).$promise.then(function(t){e.readType=i,e.readItems=t.data})["catch"](function(){angular.element(document.querySelector(".read .loadMore")).addClass("loadMore--loading--fail")})}]}}]).directive("write",["$compile","$templateRequest","$filter","Action","olUI",function(e,t,n,r,a){return{restrict:"A",scope:!1,link:function(i,o,l){function c(e){var t=(e.match(/[\x00-\x7F]+/g)||[]).join("").length,n=e.length-t;return n+Math.round(t/2)}function s(e,t){var n=[t],r=" ";return n=n.concat(e.match(/(|\s)*@([\w]+)/g)||[]),n=n.map(function(e){return e.trim()}),n=n.filter(function(e,t){return n.indexOf(e)==t}),n.forEach(function(e){r=r+e+" "}),r}function d(e){var t="quote"===y?1:0;switch(link_prefix="twitter"===w?"//twitter.com/":"weibo"===w?"//weibo.com/n/":null,e){case"text":return x.querySelectorAll("p")[t].innerText;case"name":return x.querySelectorAll(".timeline__profile__fullname strong")[t].innerText;case"avatar":return x.querySelectorAll(".timeline__profile__avatar")[t].getAttribute("src");case"screen_name":return x.querySelectorAll(".timeline__profile__fullname a")[t].getAttribute("href").replace(link_prefix,"");case"created_at":return x.querySelectorAll("[relative-date]")[t].getAttribute("relative-date")}}function u(n){var r=w+"/"+n+".html";t(r).then(function(t){t='<div class="timeline timeline--'+w+'">'+t+"</div>",I.children().empty().append(e(t)(i))})}function p(){angular.extend(i.item,{text:d("text"),retweet:{user:{name:d("name"),avatar:d("avatar"),screen_name:d("screen_name")}}})}function m(){var e={text:d("text"),created_at:d("created_at"),user:{name:d("name"),avatar:d("avatar"),screen_name:d("screen_name")}};angular.extend(i.item,"twitter"===w?{quote:e}:{retweet:e})}var f,v=i.controlCenter.split(":"),g=v[1],w=v[0].split("-")[0].split("_")[1],_=v[0].split("-")[1],h="",y=v[0].split("-")[2],b="tweet"===_||"reply"===_||"weibo"===w?140:"retweet"===_?116:null,C=o.find("button"),k=C.eq(C.length-1),S=o.find("textarea");if("tweet"!==_){var x=document.querySelector('[data-id="'+g+'"]'),q=angular.element(x);S[0].focus(),"twitter"===w&&"reply"===_?S.val(s(q.find("p")[0].innerText,"@"+v[2])):"retweet"===_&&(h="retweet","weibo"===w&&(S.val("tweet"===y?"":"retweet"===y?"//@"+v[2]+": 转发微博":"//@"+v[2]+": "+q.find("p")[0].innerText),S[0].setSelectionRange(0,0)),S.prop("required",!1),k.prop("disabled",!1))}var A=JSON.parse(localStorage.getItem("profile_"+w))||{},I=angular.element(document.querySelector(".cancelMask__wrapper"));i.item={user:{name:A.displayName,avatar:A.avatar,screen_name:A.screen_name},media:[],text:S.val().trim(),created_at:Date.now()},"retweet"===_&&p(),u("reply"===_?"tweet":_),o.on("submit",function(e){e.preventDefault();var t=S.val().trim(),n={status:t};"twitter"===w?(angular.extend(n,{geo:o.find("geo-picker").find("button").data("geo"),media_ids:o.find("media-upload").find("input").data("media_ids"),sensitive:o.find("toggle-sensitive").find("button").data("sensitive")}),"retweet"===_&&t.length>0&&(n.status=t+" https://twitter.com/"+v[2]+"/status/"+g)):"weibo"===w&&"tweet"===_&&angular.extend(n,{geo:o.find("geo-picker").data("geo")}),S.prop("disabled",!0),k.addClass("write__btn--send--sending"),r.update({action:h||_,provider:w,id:g||0},{params:n}).$promise.then(function(e){if("retweet"===_)if(a.setActionState("retweet",g,"active"),a.actionData("retweet",g,e.id_str),"quote"===h)a.setActionState("retweet",g,"frozen");else{var t=~~a.actionData("retweet",g,null,"count")+1;a.actionData("retweet",g,t,"count")}i.setControlCenter("")})["catch"](function(){k.prop("disabled",!1),S.addClassTemporarily("write__textarea--err",500)})["finally"](function(){S.prop("disabled",!1),k.removeClass("write__btn--send--sending")})}).on("input",function(){var e=S.val().trim(),t="weibo"===w?c(e):e.length;i.item.text=e,angular.element(I.find("p")[0]).html(n("linkify")(e,w)),"retweet"===_&&(e.length>0?("retweet"===h&&(m(),u("quote")),h="quote"):("quote"===h&&(p(),u("retweet")),h="retweet")),t>b||0===t&&"retweet"!==_?k.prop("disabled",!0):k.prop("disabled",!1),k.attr("data-count",t>0?t:""),k.addClassTemporarily("write__btn--send--typing",700),f?f.addClassTemporarily("actions__button--"+_+"--active",300):null}).on("$destroy",function(){o.off()})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/geoPicker.html",link:function(t,n,r){var a=n.find("button");a.on("click",function(){a.hasClass("tips--active")?a.removeClass("tips--active tips--inprocess").removeData("geo"):(a.addClass("tips--inprocess"),e.navigator.geolocation.getCurrentPosition(function(e){a.addClass("tips--active").removeClass("tips--inprocess").data("geo",{lat:e.coords.latitude,"long":e.coords.longitude})},function(e){a.removeClass("tips--inprocess").addClassTemporarily("tips--error",500)},{maximumAge:6e4,timeout:7e3}))}).on("$destroy",function(){a.off("click")})}}}]).directive("mediaUpload",["$compile","Media",function(e,t){return{restrict:"E",templateUrl:"controlCenter/write/component/mediaUpload.html",link:function(n,r,a){function i(t,r){var a=new FileReader;a.onload=function(t){var a=URL.createObjectURL(c(t.target.result));n.item.media.push({type:"photo",image_url:a,fakeId:r}),e(angular.element(document.querySelector(".cancelMask__wrapper")).contents())(n)},a.readAsDataURL(t)}function o(t){var r=document.querySelector('[data-mediaId="'+t+'"]');angular.element(r).remove(),n.item.media=n.item.media.filter(function(e){return e.fakeId!==t}),e(angular.element(document.querySelector(".cancelMask__wrapper")).contents())(n)}function l(t,a){var i=angular.element(document.querySelector('[data-mediaId="'+t+'"]'));i.removeClass("tips--inprocess").attr("data-mediaId",a).on("click",function(){var t=d.data("media_ids")||[],a=i.attr("data-mediaId"),o=t.indexOf(a);t.splice(o,1),t.length<=0?r.removeData("media_ids"):d.data("media_ids",t),n.item.media.splice(o,1),e(angular.element(document.querySelector(".cancelMask__wrapper")).contents())(n)}).on("$destroy",function(){i.off("click")})}function c(e){var t=";base64,";if(-1==e.indexOf(t)){var n=e.split(","),r=n[0].split(":")[1],a=decodeURIComponent(n[1]);return new Blob([a],{type:r})}for(var n=e.split(t),r=n[0].split(":")[1],a=window.atob(n[1]),i=a.length,o=new Uint8Array(i),l=0;i>l;++l)o[l]=a.charCodeAt(l);return new Blob([o],{type:r})}var s=a.provider,d=r.find("input");d.on("change",function(){var e=new FormData,n=d[0].files[0],r=Date.now();i(n,r),e.append("twitterMedia",n),t.upload({provider:s},e).$promise.then(function(e){var t=d.data("media_ids")||[],n=e.media_id;t.push(n),d.data("media_ids",t),l(r,n)})["catch"](function(e){o(r)}),d[0].value=""}).on("$destroy",function(){d.off("change")})}}}]).directive("toggleSensitive",function(){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/toggleSensitive.html",link:function(e,t,n){var r=t.find("button");r.on("click",function(){r.hasClass("tips--active")?r.removeClass("tips--active").data("sensitive",!1):r.addClass("tips--active").data("sensitive",!0)}).on("$destroy",function(){r.off("click")})}}});
