...
angular.module("Oneline.olControlCenterDirectives",[]).directive("replicantDeckard",["Replicant",function(e){return{restrict:"A",link:function(t,r,n){function a(){i=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));r.html(e.substr(0,7))},100);var n=[];t.providerList.forEach(function(e){var t=JSON.parse(localStorage.getItem("profile_"+e));t&&n.push(t)}),e.deckard({profileList:JSON.stringify(n)}).$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(i),r.html(e.code)},700),o=setInterval(function(){return 0>t?(a(),r.attr("data-countdown",""),void clearInterval(o)):void r.attr("data-countdown",t--)},1e3)},function(e){clearInterval(i)})}var i,o;r.on("$destroy",function(){clearInterval(i),clearInterval(o)}),a()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(e,t){return{restrict:"A",link:function(r,n,a){n.on("submit",function(a){a.preventDefault();var i=n.children(),o=i.val();i[0].blur(),e.rachael({code:o}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),r.updateProviderList(),e.profileList.forEach(function(e){localStorage.setItem("profile_"+e._provider,JSON.stringify(e))})),r.setControlCenter("")},function(e){i.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("read",[function(){return{restrict:"A",controller:["$scope","Action",function(e,t){var r=e.controlCenter.split(":"),n=r[1],a=r[0].split("-")[0].split("_")[1],i=r[0].split("-")[1];t.get({action:i,provider:a,id:n}).$promise.then(function(t){e.readType=i,e.readItems=t.data})}]}}]).directive("write",["$compile","$templateRequest","$filter","Action","olUI",function(e,t,r,n,a){return{restrict:"A",scope:!1,link:function(i,o,l){var d,s=i.controlCenter.split(":"),c=s[1],p=s[0].split("-")[0].split("_")[1],u=s[0].split("-")[1],m="",f="tweet"===u||"reply"===u||"weibo"===p?140:"retweet"===u?116:null,v=o.find("button"),w=v.eq(v.length-1),g=o.find("textarea"),_=document.querySelector(".cancelMask__wrapper"),h=angular.element(_);if("reply"===u||"retweet"===u)"twitter"===p&&"reply"===u?g.val("@"+s[2]+" "):"retweet"===u&&(g.prop("required",!1),w.prop("disabled",!1)),h.children().append(angular.element(document.querySelector('[data-id="'+c+'"]')).clone().removeClass("divider--top divider--bottom")),angular.element(_.querySelectorAll("button.tips--deep")).addClass("tips--frozen"),angular.element(_.querySelector("[data-source]")).parent().removeClass("tips--frozen"),d=angular.element(_.querySelector("[data-"+u+"]")),d.parent().removeClass("tips--deep tips--frozen");else if("tweet"===u){var y=JSON.parse(localStorage.getItem("profile_"+p))||{};i.tweetPreview={user:{name:y.displayName,avatar:y.avatar,screen_name:y.screen_name},media:[],text:"",created_at:Date.now()},t("controlCenter/write/component/livePreview--"+p+".html").then(function(t){h.children().append(e(t)(i))})}var C="";o.on("submit",function(e){e.preventDefault();var t={status:C};"twitter"===p?(angular.extend(t,{geo:o.find("geo-picker").data("geo"),media_ids:o.find("media-upload").data("media_ids")}),"retweet"===u&&C.length>0&&(m="quote",t.status=C+" https://twitter.com/"+s[2]+"/status/"+c)):"weibo"===p&&"tweet"===u&&angular.extend(t,{geo:o.find("geo-picker").data("geo")}),g.prop("disabled",!0),w.addClass("write__btn--send--sending"),n.update({action:m||u,provider:p,id:c||0},{params:t}).$promise.then(function(e){if("retweet"===u)if(a.setActionState("retweet",c,"active"),a.actionData("retweet",c,e.id_str),"quote"===m)a.setActionState("retweet",c,"frozen");else{var t=~~a.actionData("retweet",c,null,"count")+1;a.actionData("retweet",c,t,"count")}i.setControlCenter("")})["catch"](function(){w.prop("disabled",!1),g.addClassTemporarily("write__textarea--err",500)})["finally"](function(){g.prop("disabled",!1),w.removeClass("write__btn--send--sending")})}).on("input",function(){C=g.val().trim(),i.tweetPreview&&(i.tweetPreview.text=r("linkify")(C,p),i.$apply());var e=C.length;e>f||0===e?w.prop("disabled",!0):w.prop("disabled",!1),w.attr("data-count",e>0?e:""),w.addClassTemporarily("write__btn--send--typing",700),d?d.addClassTemporarily("actions__button--"+u+"--active",300):null}).on("$destroy",function(){o.off()})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/geoPicker.html",link:function(t,r,n){var a=r.find("button");a.on("click",function(){a.hasClass("tips--active")?(r.removeData("geo"),a.removeClass("tips--active tips--inprocess")):(a.addClass("tips--inprocess"),e.navigator.geolocation.getCurrentPosition(function(e){r.data("geo",{lat:e.coords.latitude,"long":e.coords.longitude}),a.addClass("tips--active"),a.removeClass("tips--inprocess")},function(e){a.removeClass("tips--inprocess"),a.addClassTemporarily("tips--error",500)},{maximumAge:6e4,timeout:7e3}))}),a.on("$destroy",function(){a.off("click")})}}}]).directive("mediaUpload",["Media",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/mediaUpload.html",link:function(t,r,n){function a(e,n){var a=new FileReader;a.onload=function(e){var r=angular.element(document.querySelectorAll(".write__previews")),a=URL.createObjectURL(l(e.target.result)),i='<span class="write__previews__item tips--active tips--inprocess animate--faster" data-mediaId><img src="'+a+'"></span>';r.append(i);var o=document.querySelectorAll(".write__previews__item"),d=angular.element(o[o.length-1]);d.attr("data-mediaId",n),t.tweetPreview&&(t.tweetPreview.media.push({type:"photo",image_url:a,fakeId:n}),t.$apply())},a.readAsDataURL(e),3===document.querySelectorAll(".write__previews__item").length&&r.css("display","none")}function i(e){var r=document.querySelector('[data-mediaId="'+e+'"]');angular.element(r).remove(),t.tweetPreview&&(t.tweetPreview.media=t.tweetPreview.media.filter(function(t){return t.fakeId!==e}),t.$apply())}function o(e,n){var a=angular.element(document.querySelector('[data-mediaId="'+e+'"]'));a.removeClass("tips--inprocess").attr("data-mediaId",n).on("click",function(){var e=r.data("media_ids")||[],n=a.attr("data-mediaId"),i=e.indexOf(n);e.splice(i,1),e.length<=0?r.removeData("media_ids"):r.data("media_ids",e),a.remove(),t.tweetPreview&&(t.tweetPreview.media.splice(i,1),t.$apply()),document.querySelectorAll(".write__previews__item").length<4&&r.attr("style","")}).on("$destroy",function(){a.off("click")})}function l(e){var t=";base64,";if(-1==e.indexOf(t)){var r=e.split(","),n=r[0].split(":")[1],a=decodeURIComponent(r[1]);return new Blob([a],{type:n})}for(var r=e.split(t),n=r[0].split(":")[1],a=window.atob(r[1]),i=a.length,o=new Uint8Array(i),l=0;i>l;++l)o[l]=a.charCodeAt(l);return new Blob([o],{type:n})}var d=n.provider,s=r.find("input");s.on("change",function(){var t=new FormData,n=s[0].files[0],l=Date.now();a(n,l),t.append("twitterMedia",n),e.upload({provider:d},t).$promise.then(function(e){var t=r.data("media_ids")||[],n=e.media_id;t.push(n),r.data("media_ids",t),o(l,n)})["catch"](function(e){i(l)}),s[0].value=""}),s.on("$destroy",function(){s.off("change")})}}}]);
...
angular.module("Oneline.olUserProfileDirectives",[]).directive("userProfile",["$timeout","$compile","$templateRequest","Action",function(e,n,t,o){return{restrict:"A",scope:{profile:"=userProfile"},link:function(i,r,l){r.on("click",function(){var a=i.profile,c=l.from,s=l.provider,u="twitter"===s?a.id_str:"instagram"===s?a.id:"weibo"===s?a.idstr:null;"controlCenter"===c&&r.hasClass("tips--frozen")||(i.user={screen_name:a.screen_name,avatar:a.avatar,name:a.name,uid:u},e(function(){var e=angular.element(document.querySelector(".cancelMask__wrapper")).children();e.empty(),t("controlCenter/read/component/user--"+s+".html").then(function(t){e.append(n(t)(i))})}),"controlCenter"===c?r.addClass("timeline__media--loading"):null,o.get({action:"user",provider:s,id:u}).$promise.then(function(e){angular.extend(i.user,e.data),"controlCenter"===c?r.addClass("timeline__media--active"):null})["catch"](function(){i.user["protected"]=!0,"controlCenter"===c?r.addClass("tips--frozen"):null})["finally"](function(){"controlCenter"===c?r.removeClass("timeline__media--loading"):null}))}),r.on("$destroy",function(){r.off("click")})}}}]).directive("toggleFollowing",["Action",function(e){return{restrict:"A",link:function(n,t,o){t.on("click",function(){var n=angular.element(document.querySelectorAll(".profile__count__column")[1]),i=t.hasClass("profile__following--active"),r=o.toggleFollowing.split(":"),l=r[0],a=r[1];t.addClass("tips--inprocess"),e[i?"destroy":"create"]({action:"follow",provider:l,id:a}).$promise.then(function(e){t.toggleClass("profile__following--active tips--active");var o=~~n.attr("data-count")+(i?-1:1);n.attr("data-count",o)})["catch"](function(e){t.addClassTemporarily("tips--error",500)})["finally"](function(){t.removeClass("tips--inprocess")})})}}}]);
