...
angular.module("Oneline.mediaDirectives",[]).directive("olVideo",function(){return{restrict:"E",scope:{olPoster:"@",olSrc:"@"},templateUrl:"media/video.html",link:function(e,t,n){var i=t.children()[0],a=angular.element(t.children()[1]);i.setAttribute("src",e.olSrc),t.on("click",function(){i.paused?i.play():i.pause(),a.toggleClass("timeline__media__playButton--playing"),t.on("mouseout",function(){i.pause(),a.removeClass("timeline__media__playButton--playing"),i.removeAttribute("loop")})}).on("$destroy",function(){t.off()}),angular.element(i).on("ended",function(){a.removeClass("timeline__media__playButton--playing")})}}}).directive("olImageThumb",function(){return{restrict:"A",link:function(e,t,n){t.on("click",function(){var e=t.parent(),i=e.next(),a=e.children(),r=i.find("img"),o=i.find("a");if(a.removeClass("timeline__media--active").addClass("timeline__media--inactive"),t.addClass("timeline__media--active timeline__media--loading"),e.addClass("timeline__media--small"),i.removeClass("timeline__media--hide"),r.attr("src",n.src.replace(/square|small/,"bmiddle")),o.attr("href",n.src.replace(/square|small/,"large")),r.on("load",function(){1===a.length?t.parent().remove():null,t.removeClass("timeline__media--loading")}),!r.data("urlList")){var l=Array.prototype.map.call(a,function(e){return angular.element(e).attr("src").replace(/square|small/,"bmiddle")});r.data("urlList",l)}}).on("$destroy",function(){t.off()})}}}).directive("selectImage",function(){return{restrict:"A",link:function(e,t,n){n.imageCount>1&&t.on("mousemove",function(e){e.offsetX-t[0].offsetWidth/2>0?(t.removeClass("cursor--pre"),t.addClass("cursor--next")):(t.removeClass("cursor--next"),t.addClass("cursor--pre"))}).on("click",function(){var e=t.find("img"),n=e.data("urlList")||[],i=n.indexOf(e.attr("src")),a=t.hasClass("cursor--next")?i+1:i-1;if(!(0>a||a>n.length-1)){var r=angular.element(angular.element(t.parent().children()[0]).children()),o=angular.element(r[a]);r.removeClass("timeline__media--active timeline__media--loading"),o.addClass("timeline__media--active timeline__media--loading"),e.on("load",function(){o.removeClass("timeline__media--loading")}).attr("src",n[a]).next().attr("href",n[a].replace("bmiddle","large"))}}).on("$destroy",function(){t.off()})}}}).directive("handleImageError",function(){return{restrict:"A",link:function(e,t,n){t.on("error",function(){""!==t.attr("src")&&t.attr("src",'data:image/svg+xml;utf8,<svg viewBox="0 0 529 530" xmlns="http://www.w3.org/2000/svg"><g fill="none"><path d="M51.245 150.775c-3.454-1.729-5.458-.098-4.476 3.638l.706 2.688c8.01 30.498-2.986 73.86-24.566 96.854l-.662.706c-2.643 2.816-1.649 5.288 2.193 5.52l136.636 8.237c9.376.565 23.953-2.031 32.554-5.798l21.279-9.319-13.768-18.801c-5.55-7.579-16.851-17.127-25.254-21.333l-124.642-62.392z" fill="#000"/><path d="M9.298 290.938c13.001 129.203 122.073 230.062 254.702 230.062 141.385 0 256-114.615 256-256s-114.615-256-256-256c-84.794 0-159.96 41.226-206.547 104.728" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/><path d="M361.259 190.733c-4.06-1.129-8.339-1.733-12.759-1.733-26.234 0-47.5 21.266-47.5 47.5 0 4.115.523 8.109 1.507 11.917" stroke="#000" stroke-width="17" stroke-linecap="round"/><path d="M213.468 406.97c13.141-16.776 37.347-28.026 65.032-28.026 30.37 0 56.552 13.538 68.536 33.056" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/></g></svg>')})}}}).directive("fuckLongWeibo",function(){return{restrict:"A",link:function(e,t,n){t.on("load",function(){var e=t[0].width,n=window.innerWidth;if(.33*n/e>2){var i=t.next();i.attr("href",i.attr("href").replace("large","bmiddle"))}})}}}).directive("olLazyImage",function(){return{restrict:"A",scope:{ratio:"@olLazyImage"},link:function(e,t,n){var i=e.ratio;t.css("padding-bottom",100*i+"%")}}}).directive("usersInPhoto",function(){return{restrict:"A",scope:{usersInPhoto:"="},link:function(e,t,n){function i(e,t,n,i){var r,o,l;return e>.5?(r=(1-e)*n,t>.5?(o=(1-t)*i,l=a(o/r)+90):(o=t*i,l=a(r/o))):(r=e*n,t>.5?(o=(1-t)*i,l=a(r/o)+180):(o=t*i,l=-a(o/r))),l}function a(e){return 180*Math.atan(e)/Math.PI}var r=e.usersInPhoto;t.on("click",function(){var e=t.parent().find("span"),n=t.parent().parent()[0];t.hasClass("tips--active--peace")?(t.removeClass("tips--active--peace"),e.parent().removeClass("timeline__media__userTag--show")):(t.addClass("tips--active--peace"),r.forEach(function(t,a){var r=angular.element(e[a]),o=n.offsetWidth,l=n.offsetHeight,s=t.position.x,c=t.position.y,d=i(s,c,o,l);r.children().css({transform:"rotate("+-d+"deg)"}),r.parent().css({top:100*c+"%",left:"calc("+100*s+"% - 16px)",transform:"rotate(0deg)"}).addClass("timeline__media__userTag--show").addClassTemporarily("timeline__media__userTag--popup",700).delay(777).then(function(e){e.css("transform","rotate("+d+"deg)")})}))}).on("$destroy",function(){t.off()})}}});
