angular.module("Oneline",["ngTouch","ngResource","ngSanitize","ngAnimate","ui.router","angular-jwt","linkify","weibo-emotify","Oneline.templates","Oneline.rootControllers","Oneline.settingsControllers","Oneline.timelineControllers","Oneline.utilsServices","Oneline.timelineServices","Oneline.RESTfulServices","Oneline.tokenHelperServices","Oneline.UIServices","Oneline.controlCenterServices","Oneline.maskServices","Oneline.utilsDirectives","Oneline.mediaDirectives","Oneline.textDirectives","Oneline.controlCenterDirectives","Oneline.maskDirectives"]).config(["$locationProvider","$stateProvider","$compileProvider","$animateProvider","$urlRouterProvider","$httpProvider","jwtInterceptorProvider","weiboEmotifyProvider",function(e,t,i,n,r,o,l,s){e.html5Mode(!0),i.aHrefSanitizationWhitelist(/^\s*(https?|blob|data|mailto):/),n.classNameFilter(/animate--\w+/),l.tokenGetter=function(){return localStorage.getItem("tokenList")},o.interceptors.push("jwtInterceptor"),r.otherwise("/"),t.state("settings",{url:"/settings",templateProvider:["$templateCache",function(e){return e.get("settings.html")}],controller:"settingsCtrl"}).state("timeline",{url:"/",templateProvider:["$templateCache",function(e){return e.get("timeline.html")}],controller:"timelineCtrl"}),s.setEmotionsURL("/public/dist/emotions_v1.min.json")}]).factory("timelineCache",["$cacheFactory",function(e){return e("timelineCache")}]).run(["$q",function(e){angular.element.prototype.addClassTemporarily=function(e,t){var i=this;return i.addClass(e),setTimeout(function(){i.removeClass(e)},t),this},angular.element.prototype.delay=function(t){var i=this;return e(function(e,n){setTimeout(function(){e(i)},t)})}}]);
angular.module("Oneline.controlCenterDirectives",[]).directive("replicantDeckard",["Replicant","store",function(e,t){return{restrict:"A",link:function(n,i,o){function r(){a=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));i.html(e.substr(0,7))},100);var o=[];n.providerList.forEach(function(e){var n=t.get("profile_"+e);n&&o.push(n)}),e.deckard({profileList:JSON.stringify(o)}).$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(a),i.html(e.code)},700),s=setInterval(function(){return 0>t?(r(),i.attr("data-countdown",""),void clearInterval(s)):void i.attr("data-countdown",t--)},1e3)},function(e){clearInterval(a)})}var a,s;i.on("$destroy",function(){clearInterval(a),clearInterval(s)}),r()}}}]).directive("replicantRachael",["Replicant","olTokenHelper","store",function(e,t,n){return{restrict:"A",link:function(i,o,r){o.on("submit",function(r){r.preventDefault();var a=o.children(),s=a.val();a[0].blur(),e.rachael({code:s}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),i.updateProviderList(),e.profileList.forEach(function(e){n.set("profile_"+e._provider,e)})),i.setControlCenter("")},function(e){a.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("read",[function(){return{restrict:"A",controller:["$scope","Action",function(e,t){var n=e.controlCenter.split(":"),i=n[1],o=n[0].split("-")[0].split("_")[1],r=n[0].split("-")[1];t.get({action:r,provider:o,id:i}).$promise.then(function(t){e.readType=r,e.readItems=t.data})["catch"](function(){angular.element(document.querySelector(".read .loadMore__btn")).addClass("loadMore__btn--loading--fail")})}]}}]).directive("notification",["$compile","$timeout",function(e,t){return{restrict:"A",link:function(n,i,o){function r(i,o){return function(){i.hasClass("notification__column--active")||(i.parent().children().removeClass("notification__column--active"),i.addClass("notification__column--active "),t(function(){var t=angular.element(document.querySelector(".cancelMask__wrapper")),i="<"+o+' provider="'+a+'"></'+o+">";t.children().empty().append(e(i)(n))}))}}var a=o.notification,s=angular.element(i.find("button")[0]),c=angular.element(i.find("button")[1]);r(s,"mentions")(),s.on("click",r(s,"mentions")).on("$destroy",function(){s.off()}),c.on("click",r(c,"direct")).on("$destroy",function(){c.off()})}}}]).directive("write",["$filter","Action","olUI","olWrite","store",function(e,t,n,i,o){return{restrict:"A",scope:!1,controller:["$scope",function(e){var t={twitter:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/,instagram:/(|\s)*@([\w\.]*)$/,weibo:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/};e.insertMention=function(e,n){i.removeText(t[n]),i.insertText(e.trim()+" ")}}],link:function(r,a,s){function c(){if(y[0].focus(),"tweet"!==m){var e=document.querySelector('[data-id="'+p+'"]'),t=angular.element(e);switch(m){case"reply":"twitter"===f&&y.val(i.extractMentions(t.find("p")[0].innerText,"@"+u[2]));break;case"retweet":"weibo"===f&&(y.val("tweet"===w?"":"retweet"===w?"//@"+u[2]+": 转发微博":"//@"+u[2]+": "+t.find("p")[0].innerText),y[0].setSelectionRange(0,0)),y.prop("required",!1),_.prop("disabled",!1)}}}function l(){var e=o.get("profile_"+f)||{};y[0].focus(),r.isShowLivePreview=!0,r.item={user:{name:e.name,avatar:e.avatar,screen_name:e.screen_name},media:[],text:y.val().trim(),created_at:Date.now(),type:v},i.generateTemplate("reply"===m?"tweet":v||m,r,f),"retweet"===v?angular.extend(r.item,i.generateRetweetUser(p,w,f)):"quote"===v?angular.extend(r.item,i.generateQuoteUser(p,w,f)):null}var d,u=r.controlCenter.split(":"),p=u[1],f=u[0].split("-")[0].split("_")[1],m=u[0].split("-")[1],v="tweet"!==m?"twitter"===f?"retweet":"tweet"!==w?"quote":"retweet":"",w=u[0].split("-")[2],g="tweet"===m||"reply"===m||"weibo"===f?140:"retweet"===m?116:null,h=a.find("button"),_=h.eq(h.length-1),y=a.find("textarea");setTimeout(function(){c()},700);var b=o.get("mentions_"+f)||[],C={twitter:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/,instagram:/(|\s)*@([\w\.]*)$/,weibo:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/};r.isShowLivePreview=!1,r.isLeftPopup=!1,r.isShowMentions=!1,r.mentionsList=b,r.showLivePreview=l,a.on("submit",function(e){e.preventDefault();var i=y.val().trim(),o={status:i};"twitter"===f?(angular.extend(o,{geo:a.find("geo-picker").find("button").data("geo"),media_ids:a.find("media-upload").find("input").data("media_ids"),sensitive:a.find("toggle-sensitive").find("button").data("sensitive")}),"retweet"===m&&i.length>0&&(o.status=i+" https://twitter.com/"+u[2]+"/status/"+p)):"weibo"===f&&"tweet"===m&&angular.extend(o,{geo:a.find("geo-picker").find("button").data("geo")}),y.prop("disabled",!0),_.addClass("write__btn--send--sending"),t.update({action:v||m,provider:f,id:p||0},{params:o}).$promise.then(function(e){if("retweet"===m)if(n.setActionState("retweet",p,"active"),n.actionData("retweet",p,e.id_str),"quote"===v&&"twitter"===f)n.setActionState("retweet",p,"frozen");else{var t=~~n.actionData("retweet",p,null,"count")+1;n.actionData("retweet",p,t,"count")}r.setControlCenter("")})["catch"](function(){_.prop("disabled",!1),y.addClassTemporarily("write__textarea--err",500)})["finally"](function(){y.prop("disabled",!1),_.removeClass("write__btn--send--sending")})}).on("input",function(){var t=y.val(),n=t.trim().length>0?t:t.trim(),o="weibo"===f?i.weiboLength(n):n.length,a=n.match(C[f]);if(a){var s=e("limitTo")(e("filter")(b,"twitter"===f?{$:a[2].trim()}:a[2].trim()),100);s.length>0?(r.isLeftPopup=i.isLeftPopup(),r.isShowMentions=!0,r.mentionsList=s,r.$apply()):r.isShowMentions=!1}else r.isShowMentions&&(r.isShowMentions=!1);r.isShowLivePreview&&(r.item.text=n,i.refreshPreviewText(n,f),"retweet"===m&&(n.length>0?("retweet"===v&&(angular.extend(r.item,i.generateQuoteUser(p,w,f)),i.generateTemplate("quote",r,f)),v="quote"):("quote"===v&&(angular.extend(r.item,i.generateRetweetUser(p,w,f)),i.generateTemplate("retweet",r,f)),v="retweet"))),o>g||0===o&&"retweet"!==m?_.prop("disabled",!0):_.prop("disabled",!1),_.attr("data-count",o>0?o:""),_.addClassTemporarily("write__btn--send--typing",700),d?d.addClassTemporarily("actions__button--"+m+"--active",300):null}).on("$destroy",function(){a.off()})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/geoPicker.html",link:function(t,n,i){var o=n.find("button");o.on("click",function(){o.hasClass("tips--active--peace")?o.removeClass("tips--active--peace tips--inprocess").removeData("geo"):(o.addClass("tips--inprocess"),e.navigator.geolocation.getCurrentPosition(function(e){o.addClass("tips--active--peace").removeClass("tips--inprocess").data("geo",{lat:e.coords.latitude,"long":e.coords.longitude})},function(e){o.removeClass("tips--inprocess").addClassTemporarily("tips--error",500)},{maximumAge:6e4,timeout:7e3}))}).on("$destroy",function(){o.off("click")})}}}]).directive("mediaUpload",["Media",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/mediaUpload.html",link:function(t,n,i){function o(e,n){var i=new FileReader,o=new Image;i.onload=function(e){var i=URL.createObjectURL(s(e.target.result));o.src=i,o.onload=function(){var e=(o.height/o.width).toFixed(5),t=angular.element(document.querySelector(".cancelMask__wrapper .timeline__media"));t.length<=0&&(angular.element(document.querySelector(".cancelMask__wrapper .timeline__content")).append('<div class="timeline__media"></div>'),t=angular.element(document.querySelector(".cancelMask__wrapper .timeline__media"))),t.append('<div class="timeline__media--large" data-mediaId="'+n+'" data-ratio="'+e+'"><img src="'+i+'"></div>')},t.item.media.push({type:"photo",image_url:i,fakeId:n}),t.$apply()},i.readAsDataURL(e)}function r(e){angular.element(document.querySelectorAll('[data-mediaId="'+e+'"]'));t.item.media=t.item.media.filter(function(t){return t.fakeId!==e}),t.$apply()}function a(e,n){var i=angular.element(document.querySelectorAll('[data-mediaId="'+e+'"]'));angular.element(i[0]).css("padding-bottom",100*i.attr("data-ratio")+"%"),i.removeClass("tips--inprocess").attr("data-mediaId",n).on("click",function(){var e=l.data("media_ids")||[],n=i.attr("data-mediaId"),o=e.indexOf(n);e.splice(o,1),e.length<=0?l.removeData("media_ids"):l.data("media_ids",e),i.remove(),t.item.media.splice(o,1),t.$apply()}).on("$destroy",function(){i.off("click")})}function s(e){var t=";base64,";if(-1==e.indexOf(t)){var n=e.split(","),i=n[0].split(":")[1],o=decodeURIComponent(n[1]);return new Blob([o],{type:i})}for(var n=e.split(t),i=n[0].split(":")[1],o=window.atob(n[1]),r=o.length,a=new Uint8Array(r),s=0;r>s;++s)a[s]=o.charCodeAt(s);return new Blob([a],{type:i})}var c=i.provider,l=n.find("input");l.on("change",function(){var t=new FormData,n=l[0].files[0];document.querySelector(".write__previews__item")||l.data("media_ids",[]);var i=Date.now();o(n,i),t.append("twitterMedia",n),e.upload({provider:c},t).$promise.then(function(e){var t=l.data("media_ids")||[],n=e.media_id;t.push(n),l.data("media_ids",t),a(i,n)})["catch"](function(e){r(i)}),l[0].value=""}).on("$destroy",function(){l.off("change")})}}}]).directive("toggleSensitive",function(){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/toggleSensitive.html",link:function(e,t,n){var i=t.find("button");i.on("click",function(){i.hasClass("tips--active--peace")?i.removeClass("tips--active--peace").data("sensitive",!1):i.addClass("tips--active--peace").data("sensitive",!0)}).on("$destroy",function(){i.off("click")})}}}).directive("weiboEmotions",["olWrite",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/weiboEmotions.html",controller:["$scope",function(t){t.isLeftPopup=!1,t.isShowEmotions=!1,t.emotionsList=[],t.insertEmotion=function(n){n="["+n+"]",e.insertText(n),t.isLeftPopup=e.isLeftPopup()}}],link:function(t,n,i){var o=n.find("button"),r="笑cry|微笑|嘻嘻|哈哈|可爱|可怜|挖鼻|吃惊|害羞|挤眼|闭嘴|鄙视|爱你|泪|偷笑|亲亲|生病|太开心|白眼|右哼哼|左哼哼|嘘|衰|委屈|吐|哈欠|抱抱|怒|疑问|馋嘴|拜拜|思考|汗|困|睡|钱|失望|酷|色|哼|鼓掌|晕|悲伤|抓狂|黑线|阴险|怒骂|互粉|心|伤心|猪头|熊猫|兔子|ok|耶|good|NO|赞|来|弱|草泥马|给力|围观|威武|奥特曼|礼物|钟|话筒|蜡烛|蛋糕|带着微博去旅行|最右|泪流满面|江南style|去旅行|doge|喵喵|哆啦A梦花心|哆啦A梦害怕|哆啦A梦吃惊|静香微笑|大雄微笑|胖虎微笑|小夫微笑";t.emotionsList=r.split("|"),o.on("click",function(){o.toggleClass("tips--active--peace"),t.$apply(function(){t.isLeftPopup=e.isLeftPopup(),t.isShowEmotions=!t.isShowEmotions}),document.querySelector("textarea").focus()}).on("$destroy",function(){o.off("click")})}}}]);
angular.module("Oneline.maskDirectives",[]).directive("showMenu",["olMask",function(t){return{restrict:"A",link:function(e,n,i){n.on("click",function(){var n=i.showMenu;t["switch"](e).then(function(){t.append("mask/menu/"+n+".html",e)})}).on("$destroy",function(){n.off()})}}}]).directive("userProfile",["Action","store","olMask",function(t,e,n){return{restrict:"A",link:function(i,o,a){o.on("click",function(){function l(){i.loadState="initLoad",i.user={screen_name:d.screen_name,avatar:d.avatar,name:d.name,uid:d.uid},i.loadUserTimeline=function(){if("loading"!==i.loadState){var t=document.querySelectorAll(".profile .timeline"),e=angular.element(t[t.length-1]).attr("data-id");i.loadState="loading",n.loadOldPosts("user_timeline",c,d.uid,e).then(function(t){i.user.timeline=i.user.timeline.concat(t),i.loadState="loadFin"})["catch"](function(t){i.loadState="loadFail"})}},n.append("mask/user/"+c+".html",i),"controlCenter"===r?o.addClass("timeline__media--loading"):null,t.get({action:"weibo"===c&&i._profile?"user_in_tweet":"user",provider:c,id:"weibo"===c&&i._profile?i._id_str:d.uid}).$promise.then(function(t){angular.extend(i.user,t.data),i.loadState="loadFin","controlCenter"===r?o.addClass("timeline__media--active"):null})["catch"](function(){i.user["protected"]=!0,i.loadState="loadFail","controlCenter"===r?o.addClass("tips--frozen"):null})["finally"](function(){"controlCenter"===r?o.removeClass("timeline__media--loading"):null})}var c=a.userProfile.split(":")[0],r=a.userProfile.split(":")[1],d=i._profile||e.get("profile_"+c);"controlCenter"===r&&o.hasClass("tips--frozen")||("timeline"===r?n["switch"](i).then(function(){l()}):l())}).on("$destroy",function(){o.off("click")})}}}]).directive("toggleFollowing",["Action",function(t){return{restrict:"A",link:function(e,n,i){n.on("click",function(){var e=angular.element(document.querySelectorAll(".profile__count__column")[1]),o=i.toggleFollowing.split(":"),a=o[0],l=o[1],c=n.hasClass("icon--"+a);n.addClass("tips--inprocess"),t[c?"destroy":"create"]({action:"follow",provider:a,id:l}).$promise.then(function(t){n.toggleClass("tips--active icon--"+a);var i=~~e.attr("data-count")+(c?-1:1);e.attr("data-count",i)})["catch"](function(t){n.addClassTemporarily("tips--error",500)})["finally"](function(){n.removeClass("tips--inprocess")})})}}}]).directive("search",["Action","olMask",function(t,e){return{restrict:"A",link:function(n,i,o){i.on("click",function(){function i(){n.loadState="initLoad",n.search={type:c,title:d,q:r},n.loadMore=function(){if("loading"!==n.loadState){var t=document.querySelectorAll(".profile .timeline"),i=angular.element(t[t.length-1]),o="weibo"===l?i.attr("data-created"):i.attr("data-id");n.loadState="loading",e.loadOldPosts(s,l,r,o).then(function(t){n.search.timeline=n.search.timeline.concat(t),n.loadState="loadFin"})["catch"](function(t){n.loadState="loadFail"})}},e.append("mask/search/"+l+".html",n),t.get({action:s,provider:l,id:r}).$promise.then(function(t){n.search.timeline=t.data,n.loadState="loadFin"})["catch"](function(){n.loadState="loadFail"})}var a=o.search.split("---"),l=a[0],c=a[1],r=a[2],d=a[3],s="twitter"===l?"search":c+"_timeline";e["switch"](n).then(function(){i()})}).on("$destroy",function(){i.off("click")})}}}]).directive("mentions",["$timeout","olNotification",function(t,e){return{restrict:"E",scope:{},templateUrl:"mask/notification/mentions/twitter.html",controller:["$scope","$element",function(n,i){var o,a=i.attr("provider");n.notifications=[],n.loadState="initLoad",o=e.initLoad(a,"mentions"),o&&o.length>0?t(function(){n.notifications=o,n.loadState="loadFin"},700):e.load(!0).then(function(t){n.notifications=t,n.loadState="loadFin"})["catch"](function(t){n.loadState="loadFail"}),n.loadMentions=function(t){"loading"!==n.loadState&&(n.loadState="loading",e.load(!1).then(function(t){n.notifications=t,n.loadState="loadFin"})["catch"](function(t){n.loadState="loadFail"}))}}]}}]).directive("direct",["$timeout","$filter","olNotification",function(t,e,n){return{restrict:"E",scope:{},templateUrl:"mask/notification/direct/twitter.html",controller:["$scope","$element","store",function(e,i,o){function a(){var t=n.extractDirect(u);t[0].length>0&&Object.keys(t[1]).length>0&&(e.senderList=t[0],r=t[1],e.showDirect(d||e.senderList[0].uid)),e.loadState="loadFin"}function l(n){e.notifications=r[n],t(function(){var t=angular.element(document.querySelector('[js-direct-sender="'+n+'"]'));t.parent().children().removeClass("tips--active--peace"),t.addClass("tips--active--peace");var e=document.querySelector(".mask__notification");e.scrollTop=e.scrollHeight})}var c,r,d,s=i.attr("provider"),u=o.get("profile_"+s).uid;e.notifications=[],e.senderList=[],e._authUid=u,e.loadState="initLoad",c=n.initLoad(s,"direct"),c&&c.length>0?t(function(){a()},700):n.load(!0).then(function(t){a()})["catch"](function(t){e.loadState="loadFail"}),e.loadDirect=function(t){"loading"!==e.loadState&&(e.loadState="loading",n.load(!1).then(function(t){a()})["catch"](function(t){e.loadState="loadFail"}))},e.showDirect=function(n){d===n?l(n):(e.notifications=[],t(function(){l(n)},350)),d=n}}]}}]);
angular.module("Oneline.mediaDirectives",[]).directive("olVideo",function(){return{restrict:"E",scope:{olPoster:"@",olSrc:"@"},templateUrl:"media/video.html",link:function(e,t,n){var i=t.children()[0],r=angular.element(t.children()[1]);i.setAttribute("src",e.olSrc),t.on("click",function(){i.paused?i.play():i.pause(),r.toggleClass("timeline__media__playButton--playing"),t.on("mouseout",function(){i.removeAttribute("loop")})}).on("$destroy",function(){t.off()}),angular.element(i).on("ended",function(){r.removeClass("timeline__media__playButton--playing")})}}}).directive("olImageThumb",function(){return{restrict:"A",link:function(e,t,n){t.on("click",function(){var e=t.parent(),i=e.next(),r=e.children(),a=i.find("img"),o=i.find("a");if(r.removeClass("timeline__media--active").addClass("timeline__media--inactive"),t.addClass("timeline__media--active timeline__media--loading"),e.addClass("timeline__media--small"),i.removeClass("timeline__media--hide"),a.attr("src",n.src.replace(/square|small/,"bmiddle")),o.attr("href",n.src.replace(/square|small/,"large")),a.on("load",function(){1===r.length?t.parent().remove():null,t.removeClass("timeline__media--loading")}),!a.data("urlList")){var l=Array.prototype.map.call(r,function(e){return angular.element(e).attr("src").replace(/square|small/,"bmiddle")});a.data("urlList",l)}}).on("$destroy",function(){t.off()})}}}).directive("selectImage",function(){return{restrict:"A",link:function(e,t,n){n.imageCount>1&&t.on("mousemove",function(e){e.offsetX-t[0].offsetWidth/2>0?(t.removeClass("cursor--pre"),t.addClass("cursor--next")):(t.removeClass("cursor--next"),t.addClass("cursor--pre"))}).on("click",function(){var e=t.find("img"),n=e.data("urlList")||[],i=n.indexOf(e.attr("src")),r=t.hasClass("cursor--next")?i+1:i-1;if(!(0>r||r>n.length-1)){var a=angular.element(angular.element(t.parent().children()[0]).children()),o=angular.element(a[r]);a.removeClass("timeline__media--active timeline__media--loading"),o.addClass("timeline__media--active timeline__media--loading"),e.on("load",function(){o.removeClass("timeline__media--loading")}).attr("src",n[r]).next().attr("href",n[r].replace("bmiddle","large"))}}).on("$destroy",function(){t.off()})}}}).directive("handleImageError",function(){return{restrict:"A",link:function(e,t,n){t.on("error",function(){""!==t.attr("src")&&t.attr("src",'data:image/svg+xml;utf8,<svg viewBox="0 0 529 530" xmlns="http://www.w3.org/2000/svg"><g fill="none"><path d="M51.245 150.775c-3.454-1.729-5.458-.098-4.476 3.638l.706 2.688c8.01 30.498-2.986 73.86-24.566 96.854l-.662.706c-2.643 2.816-1.649 5.288 2.193 5.52l136.636 8.237c9.376.565 23.953-2.031 32.554-5.798l21.279-9.319-13.768-18.801c-5.55-7.579-16.851-17.127-25.254-21.333l-124.642-62.392z" fill="#000"/><path d="M9.298 290.938c13.001 129.203 122.073 230.062 254.702 230.062 141.385 0 256-114.615 256-256s-114.615-256-256-256c-84.794 0-159.96 41.226-206.547 104.728" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/><path d="M361.259 190.733c-4.06-1.129-8.339-1.733-12.759-1.733-26.234 0-47.5 21.266-47.5 47.5 0 4.115.523 8.109 1.507 11.917" stroke="#000" stroke-width="17" stroke-linecap="round"/><path d="M213.468 406.97c13.141-16.776 37.347-28.026 65.032-28.026 30.37 0 56.552 13.538 68.536 33.056" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/></g></svg>')})}}}).directive("fuckLongWeibo",function(){return{restrict:"A",link:function(e,t,n){t.on("load",function(){var e=t[0].width,n=window.innerWidth;if(.33*n/e>2){var i=t.next();i.attr("href",i.attr("href").replace("large","bmiddle"))}})}}}).directive("olLazyImage",function(){return{restrict:"A",scope:{ratio:"@olLazyImage"},link:function(e,t,n){var i=e.ratio;t.css("padding-bottom",100*i+"%")}}}).directive("usersInPhoto",function(){return{restrict:"A",scope:{usersInPhoto:"="},link:function(e,t,n){function i(e,t,n,i){var a,o,l;return e>.5?(a=(1-e)*n,t>.5?(o=(1-t)*i,l=r(o/a)+90):(o=t*i,l=r(a/o))):(a=e*n,t>.5?(o=(1-t)*i,l=r(a/o)+180):(o=t*i,l=-r(o/a))),l}function r(e){return 180*Math.atan(e)/Math.PI}var a=e.usersInPhoto;t.on("click",function(){var e=t.parent().find("span"),n=t.parent().parent()[0];t.hasClass("tips--active--peace")?(t.removeClass("tips--active--peace"),e.parent().removeClass("timeline__media__userTag--show")):(t.addClass("tips--active--peace"),a.forEach(function(t,r){var a=angular.element(e[r]),o=n.offsetWidth,l=n.offsetHeight,s=t.position.x,c=t.position.y,d=i(s,c,o,l);a.children().css({transform:"rotate("+-d+"deg)"}),a.parent().css({top:100*c+"%",left:"calc("+100*s+"% - 16px)",transform:"rotate(0deg)"}).addClass("timeline__media__userTag--show").addClassTemporarily("timeline__media__userTag--popup",700).delay(777).then(function(e){e.css("transform","rotate("+d+"deg)")})}))}).on("$destroy",function(){t.off()})}}});
angular.module("Oneline.textDirectives",[]).directive("trimMediaLink",["$timeout",function(t){return{restrict:"A",link:function(i,n,e){t(function(){n.html(n.html().replace(e.trimMediaLink,""))})}}}]).directive("trimSuffixLink",["$timeout",function(t){return{restrict:"A",link:function(i,n,e){if("true"===e.trimSuffixLink){var r=/(?:https?\:\/\/)+(?![^\s]*?")([\w.,@?!^=%&amp;:\/~+#-]*[\w@?!^=%&amp;\/~+#-])?$/gi;t(function(){n.html(n.html().replace(r,""))})}}}}]).filter("html",["$sce",function(t){return function(i){return t.trustAsHtml(i)}}]);
...
angular.module("Oneline.UIServices",[]).service("olUI",["$filter",function(t){this.updateSocialIcon=function(t){var a={twitter:"#2AA9E0",instagram:"#3F5D87",weibo:"#E6162D"},e=["twitter","instagram","weibo"];e.forEach(function(e){var n=document.querySelectorAll('[data-provider="'+e+'"]'),i=angular.element(n[0]),o=angular.element(n[1]);t.indexOf(e)>=0?(i.attr("fill",a[e]),o.addClass("social-icon--active tips--active")):(i.attr("fill","#FFF"),o.removeClass("social-icon--active tips--active"))})},this.setLoading=function(t,a){var e=angular.element(document.querySelectorAll("[js-load-timeline]")[1===a?0:1]);"start"===t?e.removeClass("loadMore__btn--loading--fail").addClass("loadMore__btn--loading"):"done"===t?e.removeClass("loadMore__btn--loading loadMore__btn--loading--fail").parent().removeClass("loadMore--initLoad"):"fail"===t&&e.addClass("loadMore__btn--loading loadMore__btn--loading--fail")},this.isLoading=function(t){var a=angular.element(document.querySelectorAll("[js-load-timeline]")[1===t?0:1]);return a.hasClass("loadMore__btn--loading")&&!a.hasClass("loadMore__btn--loading--fail")||a.parent().hasClass("loadMore__btn--initLoad")},this.setDivider=function(a){var e=document.querySelectorAll(".timeline:not(.timeline--quote)");e=angular.element(e[1===a?0:e.length-1]),e.attr("data-date",t("date")(Date.now(),"HH:mm")).addClass(1===a?"divider divider--top":"divider divider--bottom")},this.setPostsCount=function(t,a){var e="newPosts"===t;if(e&&a%1===0){var n=(~~a).toString().split(""),i={0:"⁰",1:"¹",2:"²",3:"³",4:"⁴",5:"⁵",6:"⁶",7:"⁷",8:"⁸",9:"⁹"};__msg="",""!==a&&n.forEach(function(t){__msg+=i[t]}),document.title="｜"+__msg}document.getElementsByClassName("loadMore__btn--count")[e?0:1].setAttribute("data-count",a)};var a=function(t,a){return angular.element(document.querySelector('[data-id="'+a+'"]').querySelector("[data-"+t+"]"))};this.setActionState=function(t,e,n){var i=a(t,e);switch(n){case"wait":i.addClass("actions__button--wait");break;case"done":i.removeClass("actions__button--wait");break;case"active":i.parent().addClass("tips--active icon--"+t);break;case"inactive":i.parent().removeClass("tips--active icon--"+t);break;case"frozen":i.parent().addClass("tips--frozen")}},this.isActionActive=function(t,e){var n=a(t,e);return n.parent().hasClass("icon--"+t)},this.isActionWait=function(t,e){var n=a(t,e);return n.hasClass("actions__button--wait")},this.isActionFrozen=function(t,e){var n=a(t,e);return n.parent().hasClass("tips--frozen")},this.actionData=function(t,e,n,i){var o,r=a(t,e);return"count"===i?(r=r.next(),o="data-count"):o="data-"+t,n||""===n?void r.attr(o,n):r.attr(o)}}]);
angular.module("Oneline.controlCenterServices",[]).service("olWrite",["$compile","$templateRequest","$timeout","$filter","weiboEmotify",function(e,t,n,r,a){function i(e,t,n,r){var a=document.querySelector('[data-id="'+t+'"]'),i="quote"===n?1:0,l="twitter"===r?"//twitter.com/":"weibo"===r?"//weibo.com/n/":null;switch(e){case"text":return a.querySelectorAll("p")[i].innerText;case"name":return a.querySelectorAll(".timeline__profile__fullname strong")[i].innerText;case"avatar":return a.querySelectorAll(".timeline__profile__avatar")[i].getAttribute("src");case"screen_name":return a.querySelectorAll(".timeline__profile__fullname a")[i].getAttribute("href").replace(l,"");case"created_at":return a.querySelectorAll("[relative-date]")[i].getAttribute("relative-date")}}this.weiboLength=function(e){var t=(e.match(/[\x00-\x7F]+/g)||[]).join("").length,n=e.length-t;return n+Math.round(t/2)},this.extractMentions=function(e,t){var n=[t],r="";return n=n.concat(e.match(/(|\s)*@([\w]+)/g)||[]),n=n.map(function(e){return e.trim()}),n=n.filter(function(e,t){return n.indexOf(e)==t}),n.forEach(function(e){r=r+e+" "}),r},this.generateTemplate=function(r,a,i){var l=this,u=i+"/"+r+".html",c=angular.element(document.querySelector(".cancelMask__wrapper"));t(u).then(function(t){t='<div class="timeline timeline--'+i+' animate--enter">'+t+"</div>",c.children().empty().append(e(t)(a))}),n(function(){c.find("button").css("pointer-events","none"),l.refreshPreviewText(a.item.text,i)})},this.generateRetweetUser=function(e,t,n){return{text:i("text",e,t,n),retweet:{user:{name:i("name",e,t,n),avatar:i("avatar",e,t,n),screen_name:i("screen_name",e,t,n)}},media:[],type:"retweet"}},this.generateQuoteUser=function(e,t,n){var r={text:i("text",e,t,n),created_at:i("created_at",e,t,n),user:{name:i("name",e,t,n),avatar:i("avatar",e,t,n),screen_name:i("screen_name",e,t,n)}};return"twitter"===n?{quote:r,type:"quote"}:{retweet:r,type:"quote"}},this.refreshPreviewText=function(e,t){var i=angular.element(document.querySelector(".cancelMask__wrapper"));e=r("linkify")(e,t)||"",n(function(){"twitter"===t?angular.element(i.find("p")[0]).html(e):a.then(function(t){angular.element(i.find("p")[0]).html(t(e)||"")})})},this.insertText=function(e){var t=document.querySelector("textarea"),n=t.selectionStart,r=t.selectionEnd,a=n+e.length;n||"0"==n?t.value=t.value.substring(0,n)+e+t.value.substring(r,t.value.length):t.value+=e,angular.element(t).parent().triggerHandler("input"),t.setSelectionRange(a,a),t.focus()},this.removeText=function(e){var t=document.querySelector("textarea");t.value=t.value.replace(e," "),1===t.value.length&&(t.value="")},this.isLeftPopup=function(){var e=document.querySelector("textarea"),t=document.querySelector(".write__textarea span"),n=e.selectionStart,r=e.offsetWidth-10;t.innerHTML=e.value.substr(0,n).replace(/\n$/,"\n");var a=t.getClientRects(),i=a[a.length-1],l=i.width;return l>r/2}}]);
angular.module("Oneline.maskServices",[]).service("olMask",["$q","$timeout","$compile","$templateRequest","Action",function(t,e,n,i,r){this.append=function(t,r){e(function(){var e=angular.element(document.querySelector(".cancelMask__wrapper"));i(t,r).then(function(t){e.children().empty().append(n(t)(r))})})},this["switch"]=function(t){return t.controlCenter?t.setControlCenter("","fullmask"):t.setControlCenter("fullmask")},this.loadOldPosts=function(e,n,i,o){var a=t.defer();return r.get({action:e,provider:n,id:i,max_id:o}).$promise.then(function(t){a.resolve(t.data)})["catch"](function(t){a.reject(t)}),a.promise}}]).service("olNotification",["$q","$filter","store","Action",function(t,e,n,i){function r(t,n){return e("orderBy")(e("filter")(u,function(e,i,r){return e.sender.uid===t||e.sender.uid===n&&e.recipient.uid===t}),"created_at")}var o,a,c,u,d;this.initLoad=function(t,e){return o=t,a=e,c="mentions"===e?"notification_m_"+t:"notification_d_"+t,_info=n.get(c)||{},u=_info.notifications||[],d=_info.max_id,u},this.load=function(e){var r=t.defer();return i.get({action:a,provider:o,id:0,min_id:e?null:d}).$promise.then(function(t){t=t.data,d=t.max_id||d,t.data.length>0&&(u=u.concat(t.data),n.set(c,{notifications:u,max_id:d})),r.resolve(u)})["catch"](function(t){r.reject(t)}),r.promise},this.extractDirect=function(t){for(var e=[],n={},i=[],o=0,a=u.length;a>o;o++){var c=u[o].sender;c.uid!==t&&i.indexOf(c.uid)<0&&(e.push(u[o].sender),i.push(c.uid))}if(1===e.length){var d=e[0].uid;n[d]=r(d,t)}else e=e.sort(function(e,i){var o=e.uid,a=i.uid,c=r(o,t),u=r(a,t);n[o]=c,n[a]=u;var d=c[c.length-1].created_at;return latestCreatedAt2=u[u.length-1].created_at,d<latestCreatedAt2});return[e,n]}}]);
...
angular.module("Oneline.utilsServices",["relativeDate"]).value("relativeDateTranslations",{just_now:"0s",seconds_ago:"{{time}}s",a_minute_ago:"1m",minutes_ago:"{{time}}m",an_hour_ago:"1h",hours_ago:"{{time}}h",a_day_ago:"1d",days_ago:"{{time}}d",a_week_ago:"1w",weeks_ago:"{{time}}w",a_month_ago:"1M",months_ago:"{{time}}M",a_year_ago:"1y",years_ago:"{{time}}y",over_a_year_ago:"> 1y",seconds_from_now:"+ {{time}}s",a_minute_from_now:"+ 1m",minutes_from_now:"+ {{time}}m",an_hour_from_now:"+ 1h",hours_from_now:"+ {{time}}h",a_day_from_now:"+ 1d",days_from_now:"+ {{time}}d",a_week_from_now:"+ 1w",weeks_from_now:"+ {{time}}w",a_month_from_now:"+ 1M",months_from_now:"+ {{time}}M",a_year_from_now:"+ 1y",years_from_now:"+ {{time}}y",over_a_year_from_now:"++ 1y"}).service("store",function(){function o(o){try{o=JSON.parse(o)}catch(e){}finally{return o}}this.get=function(e){return o(localStorage.getItem(e))},this.set=function(o,e){localStorage.setItem(o,JSON.stringify(e))},this.remove=function(o){localStorage.removeItem(o)}}).service("arrayUnique",function(){this.literal=function(o){for(var e={},t=[],a=0;a<o.length;a++)e[o[a]]||(e[o[a]]=!0,t.push(o[a]));return t},this.obj=function(o){var e,t=[],a=[],_=o.length;for(e=0;_>e;e++)t[o[e].s]||(t[o[e].s]=!0,a.push(o[e]));return a}});
angular.module("Oneline.rootControllers",[]).controller("rootController",["$q","$rootScope","$window","$scope","$timeout","$state","olTokenHelper","olUI","timelineCache",function(e,n,t,r,o,i,l,a,c){r.providerList=l.getProviderList(),r.isTimeline=!1,r.controlCenter="",r.updateProviderList=function(){var e=l.getProviderList();o(function(){r.providerList=e,a.updateSocialIcon(e)})},r.setControlCenter=function(n,t){function i(e){var n=["replicant","read","write","notification"];return n.map(function(n){return e+n}).join(" ")}var l=e.defer();return r.controlCenter=n,t?o(function(){r.setControlCenter(t),l.resolve()},700):l.resolve(),o(function(){var e=angular.element(document.querySelector(".cancelMask__wrapper")),t=angular.element(document.querySelector(".controlCenter")),r=n.match(/replicant|read|write|notification/);r?(e.addClass("cancelMask__wrapper--"+r[0]),t.addClass("controlCenter--"+r[0])):(e.removeClass(i("cancelMask__wrapper--")),t.removeClass(i("controlCenter--")))}),l.promise},r["goto"]=function(e,n){var t=i.current.name;if("left"===e){if(r.providerList<=0)return;"settings"===t?i.go("timeline"):angular.element(document.querySelector("[js-show-menu]")).triggerHandler("click")}else"timeline"===t?r.controlCenter?r.setControlCenter(""):i.go("settings"):null},angular.element(t).on("keydown",function(e){27===e.keyCode&&r.$apply(function(){r.setControlCenter("")})}),n.$on("$stateChangeStart",function(e,n,t,o,a){"timeline"===n.name&&(l.isValidToken()?r.isTimeline=!0:(e.preventDefault(),i.go("settings")))}),n.$on("$stateChangeSuccess",function(e,n,t,o,i){"settings"===n.name&&(l.isValidToken()||l.clearInvalidToken(),r.isTimeline=!1),document.title="｜",c.removeAll(),r.updateProviderList(),r.setControlCenter("")})}]);
