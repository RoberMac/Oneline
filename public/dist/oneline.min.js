angular.module("Oneline",["ngTouch","ngResource","ngSanitize","ngAnimate","ui.router","angular-jwt","linkify","weibo-emotify","Oneline.templates","Oneline.rootControllers","Oneline.settingsControllers","Oneline.timelineControllers","Oneline.utilsServices","Oneline.timelineServices","Oneline.RESTfulServices","Oneline.tokenHelperServices","Oneline.UIServices","Oneline.controlCenterServices","Oneline.utilsDirectives","Oneline.mediaDirectives","Oneline.textDirectives","Oneline.controlCenterDirectives","Oneline.userProfileDirectives"]).config(["$locationProvider","$stateProvider","$compileProvider","$animateProvider","$urlRouterProvider","$httpProvider","jwtInterceptorProvider","weiboEmotifyProvider",function(e,t,i,n,r,o,l,s){e.html5Mode(!0),i.aHrefSanitizationWhitelist(/^\s*(https?|blob|data|mailto):/),n.classNameFilter(/animate--\w+/),l.tokenGetter=function(){return localStorage.getItem("tokenList")},o.interceptors.push("jwtInterceptor"),r.otherwise("/"),t.state("settings",{url:"/settings",templateProvider:["$templateCache",function(e){return e.get("settings.html")}],controller:"settingsCtrl"}).state("timeline",{url:"/",templateProvider:["$templateCache",function(e){return e.get("timeline.html")}],controller:"timelineCtrl"}),s.setEmotionsURL("/public/dist/emotions_v1.min.json")}]).factory("timelineCache",["$cacheFactory",function(e){return e("timelineCache")}]).run(["$q",function(e){angular.element.prototype.addClassTemporarily=function(e,t){var i=this;return i.addClass(e),setTimeout(function(){i.removeClass(e)},t),this},angular.element.prototype.delay=function(t){var i=this;return e(function(e,n){setTimeout(function(){e(i)},t)})}}]);
angular.module("Oneline.controlCenterDirectives",[]).directive("replicantDeckard",["Replicant","store",function(e,t){return{restrict:"A",link:function(n,i,a){function o(){r=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));i.html(e.substr(0,7))},100);var a=[];n.providerList.forEach(function(e){var n=t.get("profile_"+e);n&&a.push(n)}),e.deckard({profileList:JSON.stringify(a)}).$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(r),i.html(e.code)},700),c=setInterval(function(){return 0>t?(o(),i.attr("data-countdown",""),void clearInterval(c)):void i.attr("data-countdown",t--)},1e3)},function(e){clearInterval(r)})}var r,c;i.on("$destroy",function(){clearInterval(r),clearInterval(c)}),o()}}}]).directive("replicantRachael",["Replicant","olTokenHelper","store",function(e,t,n){return{restrict:"A",link:function(i,a,o){a.on("submit",function(o){o.preventDefault();var r=a.children(),c=r.val();r[0].blur(),e.rachael({code:c}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),i.updateProviderList(),e.profileList.forEach(function(e){n.set("profile_"+e._provider,e)})),i.setControlCenter("")},function(e){r.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("read",[function(){return{restrict:"A",controller:["$scope","Action",function(e,t){var n=e.controlCenter.split(":"),i=n[1],a=n[0].split("-")[0].split("_")[1],o=n[0].split("-")[1];t.get({action:o,provider:a,id:i}).$promise.then(function(t){e.readType=o,e.readItems=t.data})["catch"](function(){angular.element(document.querySelector(".read .loadMore")).addClass("loadMore--loading--fail")})}]}}]).directive("notification",["$templateRequest","$compile","$timeout","Action",function(e,t,n,i){return{restrict:"A",scope:{},link:function(n,a,o){var r=o.notification.split(":"),c=r[0],s=r[1];n.notifications=[],a.on("click",function(){if(!a.hasClass("notification__column--active")){a.parent().children().removeClass("notification__column--active"),a.addClass("notification__column--active ");var o=angular.element(document.querySelector(".cancelMask__wrapper"));e("mask/notification/"+c+"/"+s+".html").then(function(e){o.children().empty().append(t(e)(n))}),i.get({action:c,provider:s,id:"0"}).$promise.then(function(e){n.notifications=e.data.data})["catch"](function(e){o.children().empty(),a.removeClass("notification__column--active")})}}).on("$destroy",function(){a.off()})}}}]).directive("write",["$filter","Action","olUI","olWrite","store",function(e,t,n,i,a){return{restrict:"A",scope:!1,controller:["$scope",function(e){var t={twitter:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/,instagram:/(|\s)*@([\w\.]*)$/,weibo:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/};e.insertMention=function(e,n){i.removeText(t[n]),i.insertText(e.trim()+" ")}}],link:function(o,r,c){var s,l=o.controlCenter.split(":"),d=l[1],u=l[0].split("-")[0].split("_")[1],p=l[0].split("-")[1],m="",f=l[0].split("-")[2],v="tweet"===p||"reply"===p||"weibo"===u?140:"retweet"===p?116:null,w=r.find("button"),g=w.eq(w.length-1),h=r.find("textarea");if(h[0].focus(),"tweet"!==p){var _=document.querySelector('[data-id="'+d+'"]'),y=angular.element(_);switch(p){case"reply":"twitter"===u&&h.val(i.extractMentions(y.find("p")[0].innerText,"@"+l[2]));break;case"retweet":m="retweet","weibo"===u&&(m="tweet"!==f?"quote":"retweet",h.val("tweet"===f?"":"retweet"===f?"//@"+l[2]+": 转发微博":"//@"+l[2]+": "+y.find("p")[0].innerText),h[0].setSelectionRange(0,0)),h.prop("required",!1),g.prop("disabled",!1)}}var C=a.get("profile_"+u)||{},b=a.get("mentions_"+u),k={twitter:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/,instagram:/(|\s)*@([\w\.]*)$/,weibo:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/};o.isShowMentions=!1,o.mentionsList=b,o.item={user:{name:C.name,avatar:C.avatar,screen_name:C.screen_name},media:[],text:h.val().trim(),created_at:Date.now(),type:m},"retweet"===m?angular.extend(o.item,i.generateRetweetUser(d,f,u)):"quote"===m?angular.extend(o.item,i.generateQuoteUser(d,f,u)):null,i.generateTemplate("reply"===p?"tweet":m||p,o,u),r.on("submit",function(e){e.preventDefault();var i=h.val().trim(),a={status:i};"twitter"===u?(angular.extend(a,{geo:r.find("geo-picker").find("button").data("geo"),media_ids:r.find("media-upload").find("input").data("media_ids"),sensitive:r.find("toggle-sensitive").find("button").data("sensitive")}),"retweet"===p&&i.length>0&&(a.status=i+" https://twitter.com/"+l[2]+"/status/"+d)):"weibo"===u&&"tweet"===p&&angular.extend(a,{geo:r.find("geo-picker").data("geo")}),h.prop("disabled",!0),g.addClass("write__btn--send--sending"),t.update({action:m||p,provider:u,id:d||0},{params:a}).$promise.then(function(e){if("retweet"===p)if(n.setActionState("retweet",d,"active"),n.actionData("retweet",d,e.id_str),"quote"===m&&"twitter"===u)n.setActionState("retweet",d,"frozen");else{var t=~~n.actionData("retweet",d,null,"count")+1;n.actionData("retweet",d,t,"count")}o.setControlCenter("")})["catch"](function(){g.prop("disabled",!1),h.addClassTemporarily("write__textarea--err",500)})["finally"](function(){h.prop("disabled",!1),g.removeClass("write__btn--send--sending")})}).on("input",function(){var t=h.val(),n=t.trim().length>0?t:t.trim(),a="weibo"===u?i.weiboLength(n):n.length,r=n.match(k[u]);if(r){var c=e("limitTo")(e("filter")(b,"twitter"===u?{$:r[2].trim()}:r[2].trim()),100);c.length>0?(o.isShowMentions=!0,o.mentionsList=c):o.isShowMentions=!1}else o.isShowMentions&&(o.isShowMentions=!1);o.item.text=n,i.refreshPreviewText(n,u),"retweet"===p&&(n.length>0?("retweet"===m&&(angular.extend(o.item,i.generateQuoteUser(d,f,u)),i.generateTemplate("quote",o,u)),m="quote"):("quote"===m&&(angular.extend(o.item,i.generateRetweetUser(d,f,u)),i.generateTemplate("retweet",o,u)),m="retweet")),a>v||0===a&&"retweet"!==p?g.prop("disabled",!0):g.prop("disabled",!1),g.attr("data-count",a>0?a:""),g.addClassTemporarily("write__btn--send--typing",700),s?s.addClassTemporarily("actions__button--"+p+"--active",300):null}).on("$destroy",function(){r.off()})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/geoPicker.html",link:function(t,n,i){var a=n.find("button");a.on("click",function(){a.hasClass("tips--active--peace")?a.removeClass("tips--active--peace tips--inprocess").removeData("geo"):(a.addClass("tips--inprocess"),e.navigator.geolocation.getCurrentPosition(function(e){a.addClass("tips--active--peace").removeClass("tips--inprocess").data("geo",{lat:e.coords.latitude,"long":e.coords.longitude})},function(e){a.removeClass("tips--inprocess").addClassTemporarily("tips--error",500)},{maximumAge:6e4,timeout:7e3}))}).on("$destroy",function(){a.off("click")})}}}]).directive("mediaUpload",["Media",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/mediaUpload.html",link:function(t,n,i){function a(e,n){var i=new FileReader,a=new Image;i.onload=function(e){var i=URL.createObjectURL(c(e.target.result));a.src=i,a.onload=function(){var e=(a.height/a.width).toFixed(5),t=angular.element(document.querySelector(".cancelMask__wrapper .timeline__media"));t.length<=0&&(angular.element(document.querySelector(".cancelMask__wrapper .timeline__content")).append('<div class="timeline__media"></div>'),t=angular.element(document.querySelector(".cancelMask__wrapper .timeline__media"))),t.append('<div class="timeline__media--large" data-mediaId="'+n+'" data-ratio="'+e+'"><img src="'+i+'"></div>')},t.item.media.push({type:"photo",image_url:i,fakeId:n}),t.$apply()},i.readAsDataURL(e)}function o(e){angular.element(document.querySelectorAll('[data-mediaId="'+e+'"]'));t.item.media=t.item.media.filter(function(t){return t.fakeId!==e}),t.$apply()}function r(e,i){var a=angular.element(document.querySelectorAll('[data-mediaId="'+e+'"]'));angular.element(a[0]).css("padding-bottom",100*a.attr("data-ratio")+"%"),a.removeClass("tips--inprocess").attr("data-mediaId",i).on("click",function(){var e=l.data("media_ids")||[],i=a.attr("data-mediaId"),o=e.indexOf(i);e.splice(o,1),e.length<=0?n.removeData("media_ids"):l.data("media_ids",e),a.remove(),t.item.media.splice(o,1),t.$apply()}).on("$destroy",function(){a.off("click")})}function c(e){var t=";base64,";if(-1==e.indexOf(t)){var n=e.split(","),i=n[0].split(":")[1],a=decodeURIComponent(n[1]);return new Blob([a],{type:i})}for(var n=e.split(t),i=n[0].split(":")[1],a=window.atob(n[1]),o=a.length,r=new Uint8Array(o),c=0;o>c;++c)r[c]=a.charCodeAt(c);return new Blob([r],{type:i})}var s=i.provider,l=n.find("input");l.on("change",function(){var t=new FormData,n=l[0].files[0];document.querySelector(".write__previews__item")||l.data("media_ids",[]);var i=Date.now();a(n,i),t.append("twitterMedia",n),e.upload({provider:s},t).$promise.then(function(e){var t=l.data("media_ids")||[],n=e.media_id;t.push(n),l.data("media_ids",t),r(i,n)})["catch"](function(e){o(i)}),l[0].value=""}).on("$destroy",function(){l.off("change")})}}}]).directive("toggleSensitive",function(){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/toggleSensitive.html",link:function(e,t,n){var i=t.find("button");i.on("click",function(){i.hasClass("tips--active--peace")?i.removeClass("tips--active--peace").data("sensitive",!1):i.addClass("tips--active--peace").data("sensitive",!0)}).on("$destroy",function(){i.off("click")})}}}).directive("weiboEmotions",["olWrite",function(e){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/weiboEmotions.html",controller:["$scope",function(t){t.insertEmotion=function(t){t="["+t+"]",e.insertText(t)}}],link:function(e,t,n){var i=t.find("button"),a="笑cry|微笑|嘻嘻|哈哈|可爱|可怜|挖鼻|吃惊|害羞|挤眼|闭嘴|鄙视|爱你|泪|偷笑|亲亲|生病|太开心|白眼|右哼哼|左哼哼|嘘|衰|委屈|吐|哈欠|抱抱|怒|疑问|馋嘴|拜拜|思考|汗|困|睡|钱|失望|酷|色|哼|鼓掌|晕|悲伤|抓狂|黑线|阴险|怒骂|互粉|心|伤心|猪头|熊猫|兔子|ok|耶|good|NO|赞|来|弱|草泥马|给力|围观|威武|奥特曼|礼物|钟|话筒|蜡烛|蛋糕|带着微博去旅行|最右|泪流满面|江南style|去旅行|doge|喵喵";e.isShowEmotions=!1,e.emotionsList=a.split("|"),i.on("click",function(){i.toggleClass("tips--active--peace"),e.$apply(function(){e.isShowEmotions=!e.isShowEmotions}),document.querySelector("textarea").focus()}).on("$destroy",function(){i.off("click")})}}}]);
...
angular.module("Oneline.userProfileDirectives",[]).directive("userProfile",["$timeout","$compile","$templateRequest","Action","store",function(e,n,t,o,r){return{restrict:"A",scope:{profile:"=userProfile"},link:function(i,l,a){l.on("click",function(){var c=a.provider,s=i.profile||r.get("profile_"+c),u=a.from,d=s.uid;"controlCenter"===u&&l.hasClass("tips--frozen")||(i.user={screen_name:s.screen_name,avatar:s.avatar,name:s.name,uid:d},e(function(){var e=angular.element(document.querySelector(".cancelMask__wrapper"));t("mask/user/"+c+".html").then(function(t){e.children().empty().append(n(t)(i))})}),"controlCenter"===u?l.addClass("timeline__media--loading"):null,o.get({action:"user",provider:c,id:d}).$promise.then(function(e){angular.extend(i.user,e.data),"controlCenter"===u?l.addClass("timeline__media--active"):null})["catch"](function(){i.user["protected"]=!0,"controlCenter"===u?l.addClass("tips--frozen"):null})["finally"](function(){"controlCenter"===u?l.removeClass("timeline__media--loading"):null}))}),l.on("$destroy",function(){l.off("click")})}}}]).directive("toggleFollowing",["Action",function(e){return{restrict:"A",link:function(n,t,o){t.on("click",function(){var n=angular.element(document.querySelectorAll(".profile__count__column")[1]),r=o.toggleFollowing.split(":"),i=r[0],l=r[1],a=t.hasClass("icon--"+i);t.addClass("tips--inprocess"),e[a?"destroy":"create"]({action:"follow",provider:i,id:l}).$promise.then(function(e){t.toggleClass("tips--active icon--"+i);var o=~~n.attr("data-count")+(a?-1:1);n.attr("data-count",o)})["catch"](function(e){t.addClassTemporarily("tips--error",500)})["finally"](function(){t.removeClass("tips--inprocess")})})}}}]);
angular.module("Oneline.utilsDirectives",[]).directive("onFinishRender",["$timeout",function(i){return{restrict:"A",link:function(n,e,t){(n.$last||n.$first)&&i(function(){n.$emit(t.onFinishRender)})}}}]);
...
angular.module("Oneline.utilsServices",["relativeDate"]).value("relativeDateTranslations",{just_now:"0s",seconds_ago:"{{time}}s",a_minute_ago:"1m",minutes_ago:"{{time}}m",an_hour_ago:"1h",hours_ago:"{{time}}h",a_day_ago:"1d",days_ago:"{{time}}d",a_week_ago:"1w",weeks_ago:"{{time}}w",a_month_ago:"1M",months_ago:"{{time}}M",a_year_ago:"1y",years_ago:"{{time}}y",over_a_year_ago:"> 1y",seconds_from_now:"+ {{time}}s",a_minute_from_now:"+ 1m",minutes_from_now:"+ {{time}}m",an_hour_from_now:"+ 1h",hours_from_now:"+ {{time}}h",a_day_from_now:"+ 1d",days_from_now:"+ {{time}}d",a_week_from_now:"+ 1w",weeks_from_now:"+ {{time}}w",a_month_from_now:"+ 1M",months_from_now:"+ {{time}}M",a_year_from_now:"+ 1y",years_from_now:"+ {{time}}y",over_a_year_from_now:"++ 1y"}).service("store",function(){function e(e){try{e=JSON.parse(e)}catch(t){}finally{return e}}this.get=function(t){return e(localStorage.getItem(t))},this.set=function(e,t){localStorage.setItem(e,JSON.stringify(t))},this.remove=function(e){localStorage.removeItem(e)}}).service("olRecord",["store",function(e){function t(e){for(var t={},o=[],n=0;n<e.length;n++)t[e[n]]||(t[e[n]]=!0,o.push(e[n]));return o}function o(e){var t,o=[],n=[],a=e.length;for(t=0;a>t;t++)o[e[t].s]||(o[e[t].s]=!0,n.push(e[t]));return n}this.mentions=function(n){var a={twitter:/(|\s)*@([\w]+)/g,instagram:/(|\s)*@([\w\.]+)/g,weibo:/(|\s)*@([\u4e00-\u9fa5\w-]+)/g},r={twitter:"//twitter.com/",instagram:"//instagram.com/",weibo:"//weibo.com/n/"};n.forEach(function(n){if("instagram"!==n){var i=e.get("mentions_"+n)||[],m=[document.querySelectorAll(".timeline--"+n+" p"),document.querySelectorAll(".timeline--"+n+" .timeline__profile__fullname a")];angular.forEach(angular.element(m[0]),function(e){var t=e.innerText.match(a[n]);t&&("twitter"===n&&(t=t.map(function(e){return{s:e}})),i=i.concat(t))}),"weibo"===n&&(i=i.map(function(e){return e.trim()})),angular.forEach(angular.element(m[1]),function(e){var t=angular.element(e),o=t.attr("href");if(o){var a="@"+o.replace(r[n],"");"twitter"===n&&(a={s:a,u:t.find("strong").text()}),i=i.concat(a)}}),e.set("mentions_"+n,"twitter"===n?o(i):t(i))}})}}]);
