...
angular.module("Oneline.olControlCenterDirectives",[]).directive("replicantDeckard",["Replicant",function(e){return{restrict:"A",link:function(t,n,r){function i(){a=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));n.html(e.substr(0,7))},100),e.deckard().$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(a),n.html(e.code)},700),o=setInterval(function(){return 0>t?(i(),n.attr("data-countdown",""),void clearInterval(o)):void n.attr("data-countdown",t--)},1e3)},function(e){clearInterval(a)})}var a,o;n.on("$destroy",function(){clearInterval(a),clearInterval(o)}),i()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(e,t){return{restrict:"A",link:function(n,r,i){r.on("submit",function(i){i.preventDefault();var a=r.children(),o=a.val();a[0].blur(),e.rachael({code:o}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),n.updateProviderList()),n.setControlCenter(""),n.toggleActive({currentTarget:document.querySelector(".replicant-icon--rachael")})},function(e){a.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("read",["$window",function(e){return{restrict:"A",controller:["$scope","Action",function(e,t){var n=e.controlCenter.split(":"),r=n[1],i=n[0].split("-")[0].split("_")[1],a=n[0].split("-")[1];t.get({action:a,provider:i,id:r}).$promise.then(function(t){e.readType=a,e.readItems=t.data})}],link:function(t,n,r){var i=angular.element(e);i.on("keydown",function(e){27===e.keyCode&&t.$apply(function(){t.setControlCenter("")})}),n.on("$destroy",function(){i.off()})}}}]).directive("userProfile",["$compile","$templateRequest","Action",function(e,t,n){return{restrict:"A",scope:{profile:"=userProfile"},link:function(r,i,a){i.on("click",function(){if(!i.hasClass("tips--frozen")){var a=r.profile,o="instagram";r.user={profile:{full_name:a.full_name,profile_picture:a.profile_picture,username:a.username,isLocked:!1}};var l=angular.element(document.querySelector(".cancelMask__wrapper")).children();l.empty(),t("controlCenter/read/component/profile--instagram.html").then(function(t){l.append(e(t)(r))}),i.addClass("timeline__media--loading"),n.get({action:"user",provider:o,id:a.id}).$promise.then(function(e){r.user=e.data}).then(function(){i.addClass("timeline__media--active")})["catch"](function(){r.user.profile.isLocked=!0,i.addClass("tips--frozen")})["finally"](function(){i.removeClass("timeline__media--loading")})}}),i.on("$destroy",function(){i.off("click")})}}}]).directive("write",["$compile","$window","$templateRequest","$filter","Action","olUI",function(e,t,n,r,i,a){return{restrict:"A",scope:!1,link:function(o,l,c){var d,s=o.controlCenter.split(":"),u=s[1],p=s[0].split("-")[0].split("_")[1],m=s[0].split("-")[1],f="",v="tweet"===m||"reply"===m||"weibo"===p?140:"retweet"===m?116:null,w=angular.element(t),g=l.find("button"),_=g.eq(g.length-1),y=l.find("textarea"),h=document.querySelector(".cancelMask__wrapper"),C=angular.element(h);if("reply"===m||"retweet"===m)"twitter"===p&&"reply"===m?y.val("@"+s[2]+" "):"retweet"===m&&(y.prop("required",!1),_.prop("disabled",!1)),C.children().append(angular.element(document.querySelector('[data-id="'+u+'"]')).clone().removeClass("divider--top divider--bottom")),angular.element(h.querySelectorAll("button.tips--deep")).addClass("tips--frozen"),angular.element(h.querySelector("[data-source]")).parent().removeClass("tips--frozen"),h.offsetHeight-h.children[0].scrollHeight>72?C.addClass("vertically_center"):C.removeClass("vertically_center"),d=angular.element(h.querySelector("[data-"+m+"]")),d.parent().removeClass("tips--deep tips--frozen");else if("tweet"===m){var k=JSON.parse(localStorage.getItem("profile_"+p))||{};o.tweetPreview={user:{name:k.displayName,avatar:k.avatar,screen_name:k.screen_name},media:[],text:"",created_at:Date.now()},n("controlCenter/write/component/livePreview--"+p+".html").then(function(t){C.children().append(e(t)(o))})}var $="";l.on("submit",function(e){e.preventDefault();var t={status:$};"twitter"===p?(angular.extend(t,{geo:l.find("geo-picker").data("geo"),media_ids:l.find("media-upload").data("media_ids")}),"retweet"===m&&$.length>0&&(f="quote",t.status=$+" https://twitter.com/"+s[2]+"/status/"+u)):"weibo"===p&&"tweet"===m&&angular.extend(t,{geo:l.find("geo-picker").data("geo")}),y.prop("disabled",!0),_.addClass("write__btn--send--sending"),i.update({action:f||m,provider:p,id:u||0},{params:t}).$promise.then(function(e){"retweet"===m&&(a.setActionState("retweet",u,"active"),a.actionData("retweet",u,e.id_str),"quote"===f&&a.setActionState("retweet",u,"frozen")),o.setControlCenter("")})["catch"](function(){_.prop("disabled",!1),y.addClassTemporarily("write__textarea--err",500)})["finally"](function(){y.prop("disabled",!1),_.removeClass("write__btn--send--sending")})}).on("input",function(){$=y.val().trim(),o.tweetPreview&&(o.tweetPreview.text=r("linkify")($,p),o.$apply());var e=$.length;e>v||0===e?_.prop("disabled",!0):_.prop("disabled",!1),_.attr("data-count",e>0?e:""),_.addClassTemporarily("write__btn--send--typing",700),d?d.addClassTemporarily("actions__button--"+m+"--active",300):null}).on("$destroy",function(){l.off(),w.off()}),w.on("keydown",function(e){27===e.keyCode&&o.$apply(function(){o.setControlCenter("")})})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/geoPicker.html",link:function(t,n,r){var i=n.find("button");i.on("click",function(){i.hasClass("tips--active")?(n.removeData("geo"),i.removeClass("tips--active tips--inprocess")):(i.addClass("tips--inprocess"),e.navigator.geolocation.getCurrentPosition(function(e){n.data("geo",{lat:e.coords.latitude,"long":e.coords.longitude}),i.addClass("tips--active"),i.removeClass("tips--inprocess")},function(e){i.removeClass("tips--inprocess"),i.addClassTemporarily("tips--error",500)},{maximumAge:6e4,timeout:7e3}))}),i.on("$destroy",function(){i.off("click")})}}}]).directive("mediaUpload",["Media",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/mediaUpload.html",link:function(t,n,r){function i(e,r){var i=new FileReader;i.onload=function(e){var n=angular.element(document.querySelectorAll(".write__previews")),i=URL.createObjectURL(l(e.target.result)),a='<span class="write__previews__item tips--active tips--inprocess animate--faster" data-mediaId><img src="'+i+'"></span>';n.append(a);var o=document.querySelectorAll(".write__previews__item"),c=angular.element(o[o.length-1]);c.attr("data-mediaId",r),t.tweetPreview&&(t.tweetPreview.media.push({type:"photo",image_url:i,fakeId:r}),t.$apply())},i.readAsDataURL(e),3===document.querySelectorAll(".write__previews__item").length&&n.css("display","none")}function a(e){var n=document.querySelector('[data-mediaId="'+e+'"]');angular.element(n).remove(),t.tweetPreview&&(t.tweetPreview.media=t.tweetPreview.media.filter(function(t){return t.fakeId!==e}),t.$apply())}function o(e,r){var i=angular.element(document.querySelector('[data-mediaId="'+e+'"]'));i.removeClass("tips--inprocess").attr("data-mediaId",r).on("click",function(){var e=n.data("media_ids")||[],r=i.attr("data-mediaId"),a=e.indexOf(r);e.splice(a,1),e.length<=0?n.removeData("media_ids"):n.data("media_ids",e),i.remove(),t.tweetPreview&&(t.tweetPreview.media.splice(a,1),t.$apply()),document.querySelectorAll(".write__previews__item").length<4&&n.attr("style","")}).on("$destroy",function(){i.off("click")})}function l(e){var t=";base64,";if(-1==e.indexOf(t)){var n=e.split(","),r=n[0].split(":")[1],i=decodeURIComponent(n[1]);return new Blob([i],{type:r})}for(var n=e.split(t),r=n[0].split(":")[1],i=window.atob(n[1]),a=i.length,o=new Uint8Array(a),l=0;a>l;++l)o[l]=i.charCodeAt(l);return new Blob([o],{type:r})}var c=r.provider,d=n.find("input");d.on("change",function(){var t=new FormData,r=d[0].files[0],l=Date.now();i(r,l),t.append("twitterMedia",r),e.upload({provider:c},t).$promise.then(function(e){var t=n.data("media_ids")||[],r=e.media_id;t.push(r),n.data("media_ids",t),o(l,r)})["catch"](function(e){a(l)}),d[0].value=""}),d.on("$destroy",function(){d.off("change")})}}}]);
