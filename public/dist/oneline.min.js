...
angular.module("Oneline.utilsDirectives",[]).directive("onFinishRender",["$timeout",function(e){return{restrict:"A",link:function(n,c,o){(n.$last||n.$first)&&e(function(){n.$emit(o.onFinishRender)})}}}]).directive("loadMoreIcon",function(){return{restrict:"E",replace:!0,template:'            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">                <g fill="none" fill-rule="evenodd">                    <circle cx="42.5" cy="100" r="15"/>                    <circle cx="100" cy="100" r="15"/>                    <circle cx="157.5" cy="100.5" r="15"/>                </g>            </svg>'}}).directive("scrollTo",function(){return{restrict:"A",scope:{},link:function(e,n,c){function o(){n.removeClass(s),l=!1}var r,l,i=c.scrollTo.split(":")[0],t=c.scrollTo.split(":")[1],s="scrollTo--"+i+"--active",u=70,f=0,a=angular.element(document.querySelector('[js-scroll="'+t+'"]'));a.on("scroll",function(){var e=a.scrollTop();u>e?o():!l&&r>e&&(l=!0,n.addClass(s).delay(7e3).then(function(){o()})),r=e}),n.on("click",function(){a.scrollTop(f,700)}).on("$destroy",function(){n.off(),a.off()})}}});
...
angular.module("Oneline.maskServices",[]).service("olMask",["$q","$timeout","$compile","$templateRequest","Action",function(t,e,i,n,r){this.append=function(t,r){e(function(){var e=angular.element(document.querySelector(".cancelMask__wrapper"));n(t,r).then(function(t){e.children().empty().append(i(t)(r))})})},this.loadOldPosts=function(e,i,n,a){var o=t.defer();return r.get({action:e,provider:i,id:n,max_id:a}).$promise.then(function(t){o.resolve(t.data)})["catch"](function(t){o.reject(t)}),o.promise}}]).service("olNotification",["$q","$filter","store","Action",function(t,e,i,n){var r,a,o,d,c;this.initLoad=function(t,e){return r=t,a=e,o="mentions"===e?"notification_m_"+t:"notification_d_"+t,_info=i.get(o)||{},d=_info.notifications||[],c=_info.max_id,d},this.load=function(e){var s=t.defer();return n.get({action:a,provider:r,id:0,min_id:e?null:c}).$promise.then(function(t){t=t.data,c=t.max_id||c,t.data.length>0&&(d=d.concat(t.data),i.set(o,{notifications:d,max_id:c})),s.resolve(d)})["catch"](function(t){s.reject(t)}),s.promise},this.extractDirect=function(t){function i(t,i){return e("orderBy")(e("filter")(d,function(e,n,r){return e.sender.uid===t||e.sender.uid===i&&e.recipient.uid===t}),"created_at")}for(var n=[],r={},a=[],o=0,c=d.length;c>o;o++){var s=d[o].sender;s.uid!==t&&a.indexOf(s.uid)<0&&(n.push(d[o].sender),a.push(s.uid))}if(1===n.length){var u=n[0].uid;r[u]=i(u,t)}else n=n.sort(function(e,n){var a=e.uid,o=n.uid,d=i(a,t),c=i(o,t);r[a]=d,r[o]=c;var s=d[d.length-1].created_at;return latestCreatedAt2=c[c.length-1].created_at,s<latestCreatedAt2});return[n,r]}}]).service("olWriteMini",["$q","Action",function(t,e){var i,n;this.init=function(t,e){i=t,n=e},this.submit=function(r,a,o){var d=t.defer(),c=i.val().trim();return i.prop("disabled",!0),n.addClass("write__btn--send--sending"),e.update({action:a,provider:r,id:o||0},{params:{text:c}}).$promise.then(function(t){i.val(""),d.resolve(t)})["catch"](function(t){n.prop("disabled",!1),i.addClassTemporarily("write__textarea--err",500),d.reject(t)})["finally"](function(){i.prop("disabled",!1),n.removeClass("write__btn--send--sending").attr("data-count","")}),d.promise},this.input=function(){var t=i.val(),e=t.trim().length>0?t:t.trim(),r=e.length;r>140||0===r?n.prop("disabled",!0):n.prop("disabled",!1),n.attr("data-count",r>0?r:"").addClassTemporarily("write__btn--send--typing",700)}}]);
angular.module("Oneline.timelineServices",[]).service("olTimelineHelper",["$q","$state","Timeline","timelineCache","olUI","olTokenHelper","Action","store","arrayUnique",function(t,e,n,o,i,a,r,s,c){var u=Date.now(),l=18e5;this.initLoad=function(e){var o=t.defer(),i=this;return n.get().$promise.then(function(t){if(!t||t.data&&t.data.length<1)return void o.reject({status:304});i.storePosts("oldPosts",t,e);var n={data:[],max_id:t.max_id,max_date:t.max_date};return i.storePosts("newPosts",n,e),i.checkOldPosts(e).then(function(t){return t.length>0?i.loadOldPosts(t,e):void o.resolve()})}).then(function(){o.resolve()})["catch"](function(t){o.reject(t)}),o.promise},this.initTimelineSettings=function(){u=Date.now()},this.getId=function(t,e){var n,i,a="";return"oldPosts"===t?(n="_maxId-",i="_min_id"):(n="_minId-",i="_max_id"),e.forEach(function(t,r){var s=t+n+o.get(t+i)+(r===e.length-1?"":",");a+=s}),a},this.storePosts=function(t,e,n){var i,a,r,s=o.get(t)||[];"oldPosts"===t?(i="min",a="_min_id",r="_min_date"):(i="max",a="_max_id",r="_max_date"),n.forEach(function(t){var n=t+a,s=e[i+"_id"][t],c=t+r,u=e[i+"_date"][t];s&&o.put(n,s),u&&o.put(c,u)}),s=s.concat(e.data),o.put(t,s)},this.checkOldPosts=function(e){return t(function(t,n){var i=e.filter(function(t){return u-o.get(t+"_min_date")<l});t(i)})},this.extractOldPosts=function(t){for(var e,n=o.get("oldPosts")||[],i=!0;i;)e=n.filter(function(t){var e=u-t.created_at;return e>0&&l>=e}),u-=l,e.length>0&&(i=!1);return this.updateOldPostsCount(t),e},this.loadOldPosts=function(e,o){function i(e){var i=t.defer(),a=r.getId("oldPosts",e);return n.get({id:a}).$promise.then(function(t){!t||!t.data||t.data&&t.data.length<1?i.reject({status:304}):(r.storePosts("oldPosts",t,o),i.resolve())})["catch"](function(t){i.reject(t)}),i.promise}var a=t.defer(),r=this;return i(e).then(function(){a.resolve()})["catch"](function(t){a.reject(t)}),a.promise},this.loadNewPosts=function(e){var o=t.defer();return _this=this,n.get({id:_this.getId("newPosts",e)}).$promise.then(function(t){t.data&&t.data.length>0?(_this.storePosts("newPosts",t,e),o.resolve()):o.reject({status:304})},function(t){o.reject(t)}),o.promise},this.removeOldPosts=function(t,e,n){var i=Date.now(),a=o.get("oldPosts")||[];return a=a.concat(e),o.put("oldPosts",a),u=i-l,this.updateOldPostsCount(n),t.filter(function(t){return i-t.created_at<l})},this.updateOldPostsCount=function(t){this.checkOldPosts(t).then(function(t){if(t.length>0)i.setPostsCount("oldPosts","");else{var e=o.get("oldPosts")||[],n=0;e.forEach(function(t){var e=u-t.created_at;e>0&&l>=e&&n++}),i.setPostsCount("oldPosts",0===n?"":n)}})},this.handleError=function(t,n){if(console.log(t),t){var o=n;switch(n=o?o:1,t.status){case 304:i.setLoading("done",n);break;case 401:var r=t.data.invalidToken||["twitter","instagram","weibo"];r.forEach(function(t){a.removeToken(t)}),e.go("settings");break;case 429:var s=1e3*t.data.reset,c=new Date(s).toLocaleTimeString("en-GB").substring(0,5),u=1===n?"newPosts":"oldPosts";i.setLoading("fail",n),i.setPostsCount(u,c),setTimeout(function(){i.setPostsCount(u,"⟳")},s-Date.now());break;default:i.setLoading("fail",n)}}},this.toggleAction=function(t,e,n,o){var a=o?"destroy":"create",s=n;return"retweet"===t&&"destroy"===a&&(n=i.actionData(t,s)),r[a]({action:t,provider:e,id:n}).$promise.then(function(e){if("create"===a){if("retweet"===t&&i.actionData(t,s,e.id_str),"star"!==t){var n=~~i.actionData(t,s,null,"count")+1;i.actionData(t,s,n,"count")}}else if("star"!==t){var n=~~i.actionData(t,s,null,"count")-1;i.actionData(t,s,n>0?n:"","count")}})},this.recordMentions=function(t){var e=2e3,n=3e3,o={twitter:/(|\s)*@([\w]+)/g,instagram:/(|\s)*@([\w\.]+)/g,weibo:/(|\s)*@([\u4e00-\u9fa5\w-]+)/g},i={twitter:"//twitter.com/",instagram:"//instagram.com/",weibo:"//weibo.com/n/"};t.forEach(function(t){if("instagram"!==t){var a=s.get("mentions_"+t)||[],r=[document.querySelectorAll(".timeline--"+t+" p"),document.querySelectorAll(".timeline--"+t+" .timeline__profile__fullname a")];if(angular.forEach(angular.element(r[0]),function(n){var i=n.innerText.match(o[t]);if(i){if(i=i.map(function(t){return t.trim()}),"twitter"===t&&(i=i.map(function(t){return{s:t}})),a.length>=e){var r=i.length;"twitter"===t?a=a.filter(function(t){return!t.hasOwnProperty("u")&&r>0?(r--,!1):!0}):a.splice(0,r)}a=a.concat(i)}}),angular.forEach(angular.element(r[1]),function(e){var n=angular.element(e),o=n.attr("href");if(o){var r="@"+o.replace(i[t],"");"twitter"===t&&(r={s:r,u:n.find("strong").text()}),a.push(r)}}),a="twitter"===t?c.obj(a):c.literal(a),a.length>=n){var u=a.length-n;a.splice(0,u)}s.set("mentions_"+t,a)}})}}]);
