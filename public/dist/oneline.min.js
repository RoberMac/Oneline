...
angular.module("Oneline.textDirectives",[]).directive("trimMediaLink",["$timeout",function(t){return{restrict:"A",link:function(i,n,e){t(function(){n.html(n.html().replace(e.trimMediaLink,""))})}}}]).directive("trimSuffixLink",["$timeout",function(t){return{restrict:"A",link:function(i,n,e){if("false"!==e.trimSuffixLink){var r=/(?:https?\:\/\/)+(?![^\s]*?")([\w.,@?!^=%&amp;:\/~+#-]*[\w@?!^=%&amp;\/~+#-])?$/gi;t(function(){n.html(n.html().replace(r,""))})}}}}]).filter("html",["$sce",function(t){return function(i){return t.trustAsHtml(i)}}]);
