...
angular.module("Oneline.maskServices",[]).service("olMask",["$timeout","$compile","$templateRequest",function(e,t,n){this.append=function(i,r){e(function(){var e=angular.element(document.querySelector(".cancelMask__wrapper"));n(i,r).then(function(n){e.children().empty().append(t(n)(r))})})}}]).service("olUserProfile",["$q","Action",function(e,t){this.loadOldPosts=function(n,i){var r=e.defer(),a=document.querySelectorAll(".profile .timeline"),o=angular.element(a[a.length-1]).attr("data-id");return t.get({action:"user_timeline",provider:n,id:i,max_id:o}).$promise.then(function(e){r.resolve(e.data.data)})["catch"](function(e){r.reject(e)}),r.promise}}]).service("olNotification",["$q","$filter","store","Action",function(e,t,n,i){function r(e,n){return t("orderBy")(t("filter")(d,function(t,i,r){return t.sender.uid===e||t.sender.uid===n&&t.recipient.uid===e}),"created_at")}var a,o,c,d,u;this.initLoad=function(e,t){return a=e,o=t,c="mentions"===t?"notification_m_"+e:"notification_d_"+e,_info=n.get(c)||{},d=_info.notifications||[],u=_info.max_id,d},this.load=function(t){var r=e.defer();return i.get({action:o,provider:a,id:0,min_id:t?null:u}).$promise.then(function(e){e=e.data,u=e.max_id||u,e.data.length>0&&(d=d.concat(e.data),n.set(c,{notifications:d,max_id:u})),r.resolve(d)})["catch"](function(e){r.reject(e)}),r.promise},this.extractDirect=function(e){for(var t=[],n={},i=[],a=0,o=d.length;o>a;a++){var c=d[a].sender;c.uid!==e&&i.indexOf(c.uid)<0&&(t.push(d[a].sender),i.push(c.uid))}if(1===t.length){var u=t[0].uid;n[u]=r(u,e)}else t=t.sort(function(t,i){var a=t.uid,o=i.uid,c=r(a,e),d=r(o,e);n[a]=c,n[o]=d;var u=c[c.length-1].created_at;return latestCreatedAt2=d[d.length-1].created_at,u<latestCreatedAt2});return[t,n]}}]);
...
angular.module("Oneline.rootControllers",[]).controller("rootController",["$rootScope","$window","$scope","$timeout","$state","olTokenHelper","olUI","timelineCache",function(e,n,t,o,r,i,l,a){t.providerList=i.getProviderList(),t.isTimeline=!1,t.controlCenter="",t.updateProviderList=function(){var e=i.getProviderList();o(function(){t.providerList=e,l.updateSocialIcon(e)})},t.setControlCenter=function(e,n){function r(e){var n=["replicant","read","write","notification"];return n.map(function(n){return e+n}).join(" ")}t.controlCenter=e,n&&o(function(){t.setControlCenter(n)},700),o(function(){var n=angular.element(document.querySelector(".cancelMask__wrapper")),t=angular.element(document.querySelector(".controlCenter")),o=e.match(/replicant|read|write|notification/);o?(n.addClass("cancelMask__wrapper--"+o[0]),t.addClass("controlCenter--"+o[0])):(n.removeClass(r("cancelMask__wrapper--")),t.removeClass(r("controlCenter--")))})},t["goto"]=function(e,n){var o=r.current.name;if("left"===e){if(t.providerList<=0)return;"settings"===o?r.go("timeline"):angular.element(document.querySelector("[js-show-menu]")).triggerHandler("click")}else"timeline"===o?t.controlCenter?t.setControlCenter(""):r.go("settings"):null},angular.element(n).on("keydown",function(e){27===e.keyCode&&t.$apply(function(){t.setControlCenter("")})}),e.$on("$stateChangeStart",function(e,n,o,l,a){"timeline"===n.name&&(i.isValidToken()?t.isTimeline=!0:(e.preventDefault(),r.go("settings")))}),e.$on("$stateChangeSuccess",function(e,n,o,r,l){"settings"===n.name&&(i.isValidToken()||i.clearInvalidToken(),t.isTimeline=!1),document.title="｜",a.removeAll(),t.updateProviderList(),t.setControlCenter("")})}]);
