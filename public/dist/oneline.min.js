...
angular.module("Oneline.maskDirectives",[]).directive("showMenu",["olMask",function(t){return{restrict:"A",link:function(i,n,o){n.on("click",function(){var n=o.showMenu;i.setControlCenter("fullmask").then(function(){t.append("mask/menu/"+n+".html",i)})}).on("$destroy",function(){n.off()})}}}]).directive("userProfile",["store","$state",function(t,i){return{restrict:"A",link:function(n,o,e){o.on("click",function(){var n=e.userProfile;i.go("timeline.action",{provider:n,action:"user",id:t.get("profile_"+n).uid})})}}}]).directive("toggleFollowing",["Action",function(t){return{restrict:"A",link:function(i,n,o){n.on("click",function(){var i=angular.element(document.querySelectorAll(".profile__count__column")[1]),e=o.toggleFollowing.split(":"),a=e[0],c=e[1],r=n.hasClass("icon--"+a);n.addClass("tips--inprocess"),t[r?"destroy":"create"]({action:"follow",provider:a,id:c}).$promise.then(function(t){n.toggleClass("tips--active icon--"+a);var o=~~i.attr("data-count")+(r?-1:1);i.attr("data-count",o)})["catch"](function(t){n.addClassTemporarily("tips--error",500)})["finally"](function(){n.removeClass("tips--inprocess")})})}}}]).directive("mentions",["$timeout","olNotification",function(t,i){return{restrict:"E",scope:{},templateUrl:"mask/notification/mentions/twitter.html",controller:["$scope","$element",function(n,o){var e,a=o.attr("provider");n.notifications=[],n.loadState="initLoad",e=i.initLoad(a,"mentions"),e&&e.length>0?t(function(){n.notifications=e,n.loadState="loadFin",n.loadMentions()},700):i.load(!0).then(function(t){n.notifications=t,n.loadState="loadFin"})["catch"](function(t){n.loadState="loadFail"}),n.loadMentions=function(){"loading"!==n.loadState&&(n.loadState="loading",i.load(!1).then(function(t){n.notifications=t,n.loadState="loadFin"})["catch"](function(t){n.loadState="loadFail"}))}}]}}]).directive("direct",["$timeout","$filter","olNotification",function(t,i,n){return{restrict:"E",scope:{},templateUrl:"mask/notification/direct/twitter.html",controller:["$scope","$element","store",function(i,o,e){function a(n){i.notifications=r[n],t(function(){var t=document.querySelector(".direct__container");t.scrollTop=t.scrollHeight})}var c,r,l,d,u=o.attr("provider"),s=e.get("profile_"+u).uid;i.notifications=[],i.senderList=[],i._authUid=s,i.loadState="initLoad",c=n.initLoad(u,"direct"),c&&c.length>0?t(function(){i.updateDirect(c),i.loadDirect()},700):n.load(!0).then(function(t){i.updateDirect(t)})["catch"](function(t){i.loadState="loadFail"}),i.loadDirect=function(){"loading"!==i.loadState&&(i.loadState="loading",n.load(!1).then(function(t){i.updateDirect(t)})["catch"](function(t){i.loadState="loadFail"}))},i.showDirect=function(n,o){o?(a(n.uid),i.senderList=[n]):l&&l.uid===n.uid?(d=d.filter(function(t){return t.uid!==n.uid}),d.unshift(n),i.senderList.length===d.length?i.senderList=[n]:i.senderList=d):(i.notifications=[],t(function(){a(n.uid)},350),i.senderList=[n]),l=n},i.updateDirect=function(t){var o=n.extractDirect(s,t);o[0].length>0&&Object.keys(o[1]).length>0&&(d=o[0],r=o[1],i.showDirect(l||d[0],!0)),i.loadState="loadFin"}}]}}]).directive("writeDirect",["store","olWriteMini",function(t,i){return{restrict:"A",require:"^direct",templateUrl:"mask/component/write-mini.html",link:function(n,o,e){i.init(o.find("input"),o.find("button")),o.on("submit",function(e){e.preventDefault();var a="twitter";i.submit("twitter","direct",o.attr("write-direct")).then(function(i){var o=t.get("notification_d_"+a).notifications;o=o.concat(i.data),t.set("notification_d_"+a,{notifications:o,max_id:i.max_id}),n.updateDirect(o)})}).on("input",function(){i.input()}).on("$destroy",function(){o.off()})}}}]);
