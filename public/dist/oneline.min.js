angular.module("Oneline",["ngTouch","ngResource","ngSanitize","ui.router","angular-jwt","angular-storage","linkify","weibo-emotify","Oneline.templates","Oneline.rootControllers","Oneline.settingsControllers","Oneline.timelineControllers","Oneline.timelineServices","Oneline.actionsServices","Oneline.RESTfulServices","Oneline.relativeDateServices","Oneline.tokenHelperServices","Oneline.UIServices","Oneline.olMediaDirectives","Oneline.olTextDirectives","Oneline.olControlCenterDirectives"]).config(["$locationProvider","$stateProvider","$compileProvider","$urlRouterProvider","$httpProvider","jwtInterceptorProvider","weiboEmotifyProvider",function(e,t,n,i,r,o,l){e.html5Mode(!0),n.aHrefSanitizationWhitelist(/^\s*(https?|blob|data|mailto):/),o.tokenGetter=function(){return localStorage.getItem("tokenList")},r.interceptors.push("jwtInterceptor"),i.otherwise("/"),t.state("settings",{url:"/settings",templateProvider:["$templateCache",function(e){return e.get("settings.html")}],controller:"settingsCtrl"}).state("timeline",{url:"/",templateProvider:["$templateCache",function(e){return e.get("timeline.html")}],controller:"timelineCtrl"}),l.setEmotionsURL("/public/dist/emotions_v1.min.json")}]).factory("timelineCache",["$cacheFactory",function(e){return e("timelineCache")}]).run(["$q",function(e){angular.element.prototype.addClassTemporarily=function(e,t){var n=this;return n.addClass(e),setTimeout(function(){n.removeClass(e)},t),this},angular.element.prototype.delay=function(t){return e(function(e,n){setTimeout(function(){e()},t)})}}]);
angular.module("Oneline.olControlCenterDirectives",[]).directive("controlCenter",["$window",function(e){return{restrict:"A",link:function(t,r,n){var i=angular.element(e);i.on("keydown",function(e){27===e.keyCode&&t.$apply(function(){t.setControlCenter("")})}),r.on("$destroy",function(){i.off()})}}}]).directive("replicantDeckard",["Replicant",function(e){return{restrict:"A",link:function(t,r,n){function i(){a=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));r.html(e.substr(0,7))},100);var n=[];t.providerList.forEach(function(e){var t=JSON.parse(localStorage.getItem("profile_"+e));t&&n.push(t)}),e.deckard({profileList:JSON.stringify(n)}).$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(a),r.html(e.code)},700),o=setInterval(function(){return 0>t?(i(),r.attr("data-countdown",""),void clearInterval(o)):void r.attr("data-countdown",t--)},1e3)},function(e){clearInterval(a)})}var a,o;r.on("$destroy",function(){clearInterval(a),clearInterval(o)}),i()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(e,t){return{restrict:"A",link:function(r,n,i){n.on("submit",function(i){i.preventDefault();var a=n.children(),o=a.val();a[0].blur(),e.rachael({code:o}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),r.updateProviderList(),e.profileList.forEach(function(e){localStorage.setItem("profile_"+e._provider,JSON.stringify(e))})),r.setControlCenter("")},function(e){a.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("read",[function(){return{restrict:"A",controller:["$scope","Action",function(e,t){var r=e.controlCenter.split(":"),n=r[1],i=r[0].split("-")[0].split("_")[1],a=r[0].split("-")[1];t.get({action:a,provider:i,id:n}).$promise.then(function(t){e.readType=a,e.readItems=t.data})}]}}]).directive("userProfile",["$timeout","$compile","$templateRequest","Action",function(e,t,r,n){return{restrict:"A",scope:{profile:"=userProfile"},link:function(i,a,o){a.on("click",function(){var l=i.profile,c=o.from,s=o.provider,d="twitter"===s?l.id_str:"instagram"===s?l.id:"weibo"===s?l.idstr:null;if("instagram"===s){if("controlCenter"===c&&a.hasClass("tips--frozen"))return;i.user={screen_name:l.full_name,avatar:l.profile_picture,name:l.username,isLocked:!1}}else i.user={screen_name:l.screen_name,avatar:l.avatar,name:l.name};e(function(){var e=angular.element(document.querySelector(".cancelMask__wrapper")).children();e.empty(),r("controlCenter/read/component/user--"+s+".html").then(function(r){e.append(t(r)(i))})}),"controlCenter"===c?a.addClass("timeline__media--loading"):null,n.get({action:"user",provider:s,id:d}).$promise.then(function(e){angular.extend(i.user,e.data),"controlCenter"===c?a.addClass("timeline__media--active"):null})["catch"](function(){i.user.isLocked=!0,"controlCenter"===c?a.addClass("tips--frozen"):null})["finally"](function(){"controlCenter"===c?a.removeClass("timeline__media--loading"):null})}),a.on("$destroy",function(){a.off("click")})}}}]).directive("write",["$compile","$templateRequest","$filter","Action","olUI",function(e,t,r,n,i){return{restrict:"A",scope:!1,link:function(a,o,l){var c,s=a.controlCenter.split(":"),d=s[1],u=s[0].split("-")[0].split("_")[1],p=s[0].split("-")[1],m="",f="tweet"===p||"reply"===p||"weibo"===u?140:"retweet"===p?116:null,v=o.find("button"),w=v.eq(v.length-1),g=o.find("textarea"),_=document.querySelector(".cancelMask__wrapper"),h=angular.element(_);if("reply"===p||"retweet"===p)"twitter"===u&&"reply"===p?g.val("@"+s[2]+" "):"retweet"===p&&(g.prop("required",!1),w.prop("disabled",!1)),h.children().append(angular.element(document.querySelector('[data-id="'+d+'"]')).clone().removeClass("divider--top divider--bottom")),angular.element(_.querySelectorAll("button.tips--deep")).addClass("tips--frozen"),angular.element(_.querySelector("[data-source]")).parent().removeClass("tips--frozen"),_.offsetHeight-_.children[0].scrollHeight>72?h.addClass("vertically_center"):h.removeClass("vertically_center"),c=angular.element(_.querySelector("[data-"+p+"]")),c.parent().removeClass("tips--deep tips--frozen");else if("tweet"===p){var y=JSON.parse(localStorage.getItem("profile_"+u))||{};a.tweetPreview={user:{name:y.displayName,avatar:y.avatar,screen_name:y.screen_name},media:[],text:"",created_at:Date.now()},t("controlCenter/write/component/livePreview--"+u+".html").then(function(t){h.children().append(e(t)(a))})}var C="";o.on("submit",function(e){e.preventDefault();var t={status:C};"twitter"===u?(angular.extend(t,{geo:o.find("geo-picker").data("geo"),media_ids:o.find("media-upload").data("media_ids")}),"retweet"===p&&C.length>0&&(m="quote",t.status=C+" https://twitter.com/"+s[2]+"/status/"+d)):"weibo"===u&&"tweet"===p&&angular.extend(t,{geo:o.find("geo-picker").data("geo")}),g.prop("disabled",!0),w.addClass("write__btn--send--sending"),n.update({action:m||p,provider:u,id:d||0},{params:t}).$promise.then(function(e){"retweet"===p&&(i.setActionState("retweet",d,"active"),i.actionData("retweet",d,e.id_str),"quote"===m&&i.setActionState("retweet",d,"frozen")),a.setControlCenter("")})["catch"](function(){w.prop("disabled",!1),g.addClassTemporarily("write__textarea--err",500)})["finally"](function(){g.prop("disabled",!1),w.removeClass("write__btn--send--sending")})}).on("input",function(){C=g.val().trim(),a.tweetPreview&&(a.tweetPreview.text=r("linkify")(C,u),a.$apply());var e=C.length;e>f||0===e?w.prop("disabled",!0):w.prop("disabled",!1),w.attr("data-count",e>0?e:""),w.addClassTemporarily("write__btn--send--typing",700),c?c.addClassTemporarily("actions__button--"+p+"--active",300):null}).on("$destroy",function(){o.off()})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/geoPicker.html",link:function(t,r,n){var i=r.find("button");i.on("click",function(){i.hasClass("tips--active")?(r.removeData("geo"),i.removeClass("tips--active tips--inprocess")):(i.addClass("tips--inprocess"),e.navigator.geolocation.getCurrentPosition(function(e){r.data("geo",{lat:e.coords.latitude,"long":e.coords.longitude}),i.addClass("tips--active"),i.removeClass("tips--inprocess")},function(e){i.removeClass("tips--inprocess"),i.addClassTemporarily("tips--error",500)},{maximumAge:6e4,timeout:7e3}))}),i.on("$destroy",function(){i.off("click")})}}}]).directive("mediaUpload",["Media",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/mediaUpload.html",link:function(t,r,n){function i(e,n){var i=new FileReader;i.onload=function(e){var r=angular.element(document.querySelectorAll(".write__previews")),i=URL.createObjectURL(l(e.target.result)),a='<span class="write__previews__item tips--active tips--inprocess animate--faster" data-mediaId><img src="'+i+'"></span>';r.append(a);var o=document.querySelectorAll(".write__previews__item"),c=angular.element(o[o.length-1]);c.attr("data-mediaId",n),t.tweetPreview&&(t.tweetPreview.media.push({type:"photo",image_url:i,fakeId:n}),t.$apply())},i.readAsDataURL(e),3===document.querySelectorAll(".write__previews__item").length&&r.css("display","none")}function a(e){var r=document.querySelector('[data-mediaId="'+e+'"]');angular.element(r).remove(),t.tweetPreview&&(t.tweetPreview.media=t.tweetPreview.media.filter(function(t){return t.fakeId!==e}),t.$apply())}function o(e,n){var i=angular.element(document.querySelector('[data-mediaId="'+e+'"]'));i.removeClass("tips--inprocess").attr("data-mediaId",n).on("click",function(){var e=r.data("media_ids")||[],n=i.attr("data-mediaId"),a=e.indexOf(n);e.splice(a,1),e.length<=0?r.removeData("media_ids"):r.data("media_ids",e),i.remove(),t.tweetPreview&&(t.tweetPreview.media.splice(a,1),t.$apply()),document.querySelectorAll(".write__previews__item").length<4&&r.attr("style","")}).on("$destroy",function(){i.off("click")})}function l(e){var t=";base64,";if(-1==e.indexOf(t)){var r=e.split(","),n=r[0].split(":")[1],i=decodeURIComponent(r[1]);return new Blob([i],{type:n})}for(var r=e.split(t),n=r[0].split(":")[1],i=window.atob(r[1]),a=i.length,o=new Uint8Array(a),l=0;a>l;++l)o[l]=i.charCodeAt(l);return new Blob([o],{type:n})}var c=n.provider,s=r.find("input");s.on("change",function(){var t=new FormData,n=s[0].files[0],l=Date.now();i(n,l),t.append("twitterMedia",n),e.upload({provider:c},t).$promise.then(function(e){var t=r.data("media_ids")||[],n=e.media_id;t.push(n),r.data("media_ids",t),o(l,n)})["catch"](function(e){a(l)}),s[0].value=""}),s.on("$destroy",function(){s.off("change")})}}}]);
...
angular.module("Oneline.rootControllers",[]).controller("rootController",["$rootScope","$scope","$timeout","$state","olTokenHelper","olUI","timelineCache",function(e,t,n,o,i,r,l){t.providerList=i.getProviderList(),t.isTimeline=!1,t.controlCenter="",t.updateProviderList=function(){var e=i.getProviderList();n(function(){t.providerList=e,r.updateSocialIcon(e)})},t.setControlCenter=function(e,n){t.controlCenter=e,n&&setTimeout(function(){t.controlCenter=n},700)},t["goto"]=function(e,n){var i=o.current.name;if("left"===e){if(t.providerList<=0)return;"settings"===i?o.go("timeline"):t.providerList.indexOf("twitter")>=0?t.setControlCenter("write_twitter-tweet"):t.providerList.indexOf("weibo")>=0?t.setControlCenter("write_weibo-tweet"):null}else"timeline"===i?/read|write/.test(t.controlCenter)?t.setControlCenter(""):o.go("settings"):null},e.$on("$stateChangeStart",function(e,n,r,l,s){"timeline"===n.name&&(i.isValidToken()?t.isTimeline=!0:(e.preventDefault(),o.go("settings")))}),e.$on("$stateChangeSuccess",function(e,n,o,r,s){"settings"===n.name&&(i.isValidToken()||i.clearInvalidToken(),t.isTimeline=!1),document.title="｜",l.removeAll(),t.updateProviderList(),t.controlCenter=""})}]);
