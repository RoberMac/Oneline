...
angular.module("Oneline.utilsDirectives",[]).directive("onFinishRender",["$timeout",function(t){return{restrict:"A",link:function(i,e,n){(i.$last||i.$first)&&t(function(){i.$emit(n.onFinishRender)})}}}]).directive("disableBack",function(){return{restrict:"A",link:function(t,i,e){i.on("mousewheel",function(t){var i=this.scrollWidth-this.offsetWidth;(this.scrollLeft+t.deltaX<0||this.scrollLeft+t.deltaX>i)&&(t.preventDefault(),this.scrollLeft=Math.max(0,Math.min(i,this.scrollLeft+t.deltaX)))}).on("$destroy",function(){i.off()})}}});
...
angular.module("Oneline.timelineServices",[]).service("olTimelineHelper",["$q","$state","Timeline","timelineCache","olUI","olTokenHelper","Action",function(t,e,n,o,s,i,a){var r=Date.now(),c=18e5;this.initLoad=function(e){var o=t.defer(),s=this;return n.initLoad().$promise.then(function(t){if(!t||t.data&&t.data.length<1)return void o.reject({status:304});s.storePosts("oldPosts",t,e);var n={data:[],max_id:t.max_id,max_date:t.max_date};return s.storePosts("newPosts",n,e),s.checkOldPosts(e).then(function(t){return t.length>0?s.loadOldPosts(t,e):void o.resolve()})}).then(function(){o.resolve()})["catch"](function(t){o.reject(t)}),o.promise},this.initTimelineSettings=function(){r=Date.now()},this.getId=function(t,e){var n,s,i=(o.get(t),"");return"oldPosts"===t?(n="_maxId-",s="_min_id"):(n="_minId-",s="_max_id"),e.forEach(function(t,a){var r=(o.get("oldPosts"),t+n+o.get(t+s)+(a===e.length-1?"":","));i+=r}),i},this.storePosts=function(t,e,n){var s,i,a,r=o.get(t)||[];"oldPosts"===t?(s="min",i="_min_id",a="_min_date"):(s="max",i="_max_id",a="_max_date"),n.forEach(function(t){var n=t+i,r=e[s+"_id"][t],c=t+a,d=e[s+"_date"][t];r&&o.put(n,r),d&&o.put(c,d)}),r=r.concat(e.data),o.put(t,r)},this.checkOldPosts=function(e){return t(function(t,n){var s=e.filter(function(t){return r-o.get(t+"_min_date")<c});t(s)})},this.extractOldPosts=function(t){for(var e,n=o.get("oldPosts")||[],s=!0;s;)e=n.filter(function(t){var e=r-t.created_at;return e>0&&c>=e}),r-=c,e.length>0&&(s=!1);return this.updateOldPostsCount(t),e},this.loadOldPosts=function(e,o){function s(e){var s=t.defer(),i=r.getId("oldPosts",e);return n.load({id:i,count:100}).$promise.then(function(t){return!t||t.data&&t.data.length<1?void s.reject({status:304}):(t.min_date.twitter&&t.data.splice(0,1),r.storePosts("oldPosts",t,o),void s.resolve())})["catch"](function(t){s.reject(t)}),s.promise}function i(){var e=t.defer();return r.checkOldPosts(o).then(function(t){t.length>0?s(t).then(i).then(function(){e.resolve()})["catch"](function(t){e.reject(t)}):e.resolve()}),e.promise}var a=t.defer(),r=this;return s(e).then(i).then(function(){a.resolve()})["catch"](function(t){a.reject(t)}),a.promise},this.loadNewPosts=function(e){var o=t.defer();return _this=this,n.load({id:_this.getId("newPosts",e),count:100}).$promise.then(function(t){t.data&&t.data.length>0?(_this.storePosts("newPosts",t,e),o.resolve()):o.reject({status:304})},function(t){o.reject(t)}),o.promise},this.removeOldPosts=function(t,e,n){var s=Date.now(),i=o.get("oldPosts")||[];return i=i.concat(e),o.put("oldPosts",i),r=s-c,this.updateOldPostsCount(n),console.time("filter"),t.filter(function(t){return s-t.created_at<c})},this.updateOldPostsCount=function(t){this.checkOldPosts(t).then(function(t){if(t.length>0)s.setPostsCount("oldPosts","");else{var e=o.get("oldPosts")||[],n=0;e.forEach(function(t){var e=r-t.created_at;e>0&&c>=e&&n++}),s.setPostsCount("oldPosts",0===n?"":n)}})},this.handleError=function(t,n){if(console.log(t),t){var o=n;switch(n=o?o:1,t.status){case 304:s.setLoading("done",n);break;case 401:var a=t.data.invalidToken||["twitter","instagram","weibo"];a.forEach(function(t){i.removeToken(t)}),e.go("settings");break;case 429:var r=1e3*t.data.reset,c=new Date(r).toLocaleTimeString("en-GB").substring(0,5);s.setLoading("fail",n),s.setPostsCount("newPosts",c),console.log(r,r-Date.now()),setTimeout(function(){s.setPostsCount("newPosts","⟳")},r-Date.now());break;default:s.setLoading("fail",n)}}},this.toggleAction=function(t,e,n,o){var i=o?"destroy":"create",r=n;return"retweet"===t&&"destroy"===i&&(n=s.actionData(t,r)),a[i]({action:t,provider:e,id:n}).$promise.then(function(e){if("create"===i){if("retweet"===t&&s.actionData(t,r,e.id_str),"star"!==t){var n=~~s.actionData(t,r,null,"count")+1;s.actionData(t,r,n,"count")}}else if("star"!==t){var n=~~s.actionData(t,r,null,"count")-1;s.actionData(t,r,n>0?n:"","count")}})}}]);
...
angular.module("Oneline.utilsServices",["relativeDate"]).value("relativeDateTranslations",{just_now:"0s",seconds_ago:"{{time}}s",a_minute_ago:"1m",minutes_ago:"{{time}}m",an_hour_ago:"1h",hours_ago:"{{time}}h",a_day_ago:"1d",days_ago:"{{time}}d",a_week_ago:"1w",weeks_ago:"{{time}}w",a_month_ago:"1M",months_ago:"{{time}}M",a_year_ago:"1y",years_ago:"{{time}}y",over_a_year_ago:"> 1y",seconds_from_now:"+ {{time}}s",a_minute_from_now:"+ 1m",minutes_from_now:"+ {{time}}m",an_hour_from_now:"+ 1h",hours_from_now:"+ {{time}}h",a_day_from_now:"+ 1d",days_from_now:"+ {{time}}d",a_week_from_now:"+ 1w",weeks_from_now:"+ {{time}}w",a_month_from_now:"+ 1M",months_from_now:"+ {{time}}M",a_year_from_now:"+ 1y",years_from_now:"+ {{time}}y",over_a_year_from_now:"++ 1y"}).service("store",function(){function e(e){try{e=JSON.parse(e)}catch(t){}finally{return e}}this.get=function(t){return e(localStorage.getItem(t))},this.set=function(e,t){localStorage.setItem(e,JSON.stringify(t))},this.remove=function(e){localStorage.removeItem(e)}}).service("olRecord",["store",function(e){function t(e){for(var t={},n=[],o=0;o<e.length;o++)t[e[o]]||(t[e[o]]=!0,n.push(e[o]));return n}function n(e){var t,n=[],o=[],r=e.length;for(t=0;r>t;t++)n[e[t].s]||(n[e[t].s]=!0,o.push(e[t]));return o}this.mentions=function(o){var r=2e3,a={twitter:/(|\s)*@([\w]+)/g,instagram:/(|\s)*@([\w\.]+)/g,weibo:/(|\s)*@([\u4e00-\u9fa5\w-]+)/g},i={twitter:"//twitter.com/",instagram:"//instagram.com/",weibo:"//weibo.com/n/"};o.forEach(function(o){if("instagram"!==o){var m=e.get("mentions_"+o)||[],_=[document.querySelectorAll(".timeline--"+o+" p"),document.querySelectorAll(".timeline--"+o+" .timeline__profile__fullname a")];angular.forEach(angular.element(_[0]),function(e){var t=e.innerText.match(a[o]);if(t){if("twitter"===o&&(t=t.map(function(e){return{s:e.trim()}})),m.length>=r)if("twitter"===o){var n=t.length;m=m.filter(function(e){return!e.hasOwnProperty("u")&&n>0?(n--,!1):!0})}else m.splice(0,t.length);m=m.concat(t)}}),"weibo"===o&&(m=m.map(function(e){return e.trim()})),angular.forEach(angular.element(_[1]),function(e){var t=angular.element(e),n=t.attr("href");if(n){var r="@"+n.replace(i[o],"");"twitter"===o&&(r={s:r,u:t.find("strong").text()}),m.push(r)}}),e.set("mentions_"+o,"twitter"===o?n(m):t(m))}})}}]);
