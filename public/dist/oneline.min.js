angular.module("Oneline",["ngTouch","ngResource","ngSanitize","ngAnimate","ui.router","angular-jwt","angular-storage","linkify","weibo-emotify","Oneline.templates","Oneline.rootControllers","Oneline.settingsControllers","Oneline.timelineControllers","Oneline.timelineServices","Oneline.actionsServices","Oneline.RESTfulServices","Oneline.relativeDateServices","Oneline.tokenHelperServices","Oneline.UIServices","Oneline.olMediaDirectives","Oneline.olTextDirectives","Oneline.olControlCenterDirectives","Oneline.olUserProfileDirectives","Oneline.olUtilsDirectives"]).config(["$locationProvider","$stateProvider","$compileProvider","$urlRouterProvider","$httpProvider","jwtInterceptorProvider","weiboEmotifyProvider",function(e,t,i,n,r,o,l){e.html5Mode(!0),i.aHrefSanitizationWhitelist(/^\s*(https?|blob|data|mailto):/),o.tokenGetter=function(){return localStorage.getItem("tokenList")},r.interceptors.push("jwtInterceptor"),n.otherwise("/"),t.state("settings",{url:"/settings",templateProvider:["$templateCache",function(e){return e.get("settings.html")}],controller:"settingsCtrl"}).state("timeline",{url:"/",templateProvider:["$templateCache",function(e){return e.get("timeline.html")}],controller:"timelineCtrl"}),l.setEmotionsURL("/public/dist/emotions_v1.min.json")}]).factory("timelineCache",["$cacheFactory",function(e){return e("timelineCache")}]).run(["$q",function(e){angular.element.prototype.addClassTemporarily=function(e,t){var i=this;return i.addClass(e),setTimeout(function(){i.removeClass(e)},t),this},angular.element.prototype.delay=function(t){var i=this;return e(function(e,n){setTimeout(function(){e(i)},t)})}}]);
angular.module("Oneline.olControlCenterDirectives",[]).directive("replicantDeckard",["Replicant",function(e){return{restrict:"A",link:function(t,n,i){function r(){a=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));n.html(e.substr(0,7))},100);var i=[];t.providerList.forEach(function(e){var t=JSON.parse(localStorage.getItem("profile_"+e));t&&i.push(t)}),e.deckard({profileList:JSON.stringify(i)}).$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(a),n.html(e.code)},700),o=setInterval(function(){return 0>t?(r(),n.attr("data-countdown",""),void clearInterval(o)):void n.attr("data-countdown",t--)},1e3)},function(e){clearInterval(a)})}var a,o;n.on("$destroy",function(){clearInterval(a),clearInterval(o)}),r()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(e,t){return{restrict:"A",link:function(n,i,r){i.on("submit",function(r){r.preventDefault();var a=i.children(),o=a.val();a[0].blur(),e.rachael({code:o}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),n.updateProviderList(),e.profileList.forEach(function(e){localStorage.setItem("profile_"+e._provider,JSON.stringify(e))})),n.setControlCenter("")},function(e){a.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("read",[function(){return{restrict:"A",controller:["$scope","Action",function(e,t){var n=e.controlCenter.split(":"),i=n[1],r=n[0].split("-")[0].split("_")[1],a=n[0].split("-")[1];t.get({action:a,provider:r,id:i}).$promise.then(function(t){e.readType=a,e.readItems=t.data})["catch"](function(){angular.element(document.querySelector(".read .loadMore")).addClass("loadMore--loading--fail")})}]}}]).directive("write",["$compile","$templateRequest","$timeout","$filter","weiboEmotify","Action","olUI",function(e,t,n,i,r,a,o){return{restrict:"A",scope:!1,link:function(l,c,s){function d(e){var t=(e.match(/[\x00-\x7F]+/g)||[]).join("").length,n=e.length-t;return n+Math.round(t/2)}function u(e,t){var n=[t],i=" ";return n=n.concat(e.match(/(|\s)*@([\w]+)/g)||[]),n=n.map(function(e){return e.trim()}),n=n.filter(function(e,t){return n.indexOf(e)==t}),n.forEach(function(e){i=i+e+" "}),i}function m(e){var t="quote"===C?1:0;switch(link_prefix="twitter"===y?"//twitter.com/":"weibo"===y?"//weibo.com/n/":null,e){case"text":return I.querySelectorAll("p")[t].innerText;case"name":return I.querySelectorAll(".timeline__profile__fullname strong")[t].innerText;case"avatar":return I.querySelectorAll(".timeline__profile__avatar")[t].getAttribute("src");case"screen_name":return I.querySelectorAll(".timeline__profile__fullname a")[t].getAttribute("href").replace(link_prefix,"");case"created_at":return I.querySelectorAll("[relative-date]")[t].getAttribute("relative-date")}}function p(i){var r=y+"/"+i+".html";t(r).then(function(t){t='<div class="timeline timeline--'+y+'">'+t+"</div>",D.children().empty().append(e(t)(l))}),n(function(){D.find("button").css("pointer-events","none")}),g(l.item.text)}function f(){angular.extend(l.item,{text:m("text"),retweet:{user:{name:m("name"),avatar:m("avatar"),screen_name:m("screen_name")}},media:[],type:"retweet"})}function v(){var e={text:m("text"),created_at:m("created_at"),user:{name:m("name"),avatar:m("avatar"),screen_name:m("screen_name")}};angular.extend(l.item,"twitter"===y?{quote:e,type:"quote"}:{retweet:e,type:"quote"})}function g(e){e=i("linkify")(e,y)||"",n(function(){"twitter"===y?angular.element(D.find("p")[0]).html(e):r.then(function(t){angular.element(D.find("p")[0]).html(t(e)||"")})})}var w,_=l.controlCenter.split(":"),h=_[1],y=_[0].split("-")[0].split("_")[1],b=_[0].split("-")[1],k="",C=_[0].split("-")[2],S="tweet"===b||"reply"===b||"weibo"===y?140:"retweet"===b?116:null,q=c.find("button"),x=q.eq(q.length-1),A=c.find("textarea");if(A[0].focus(),"tweet"!==b){var I=document.querySelector('[data-id="'+h+'"]'),$=angular.element(I);switch(b){case"reply":"twitter"===y&&A.val(u($.find("p")[0].innerText,"@"+_[2]));break;case"retweet":k="retweet","weibo"===y&&(k="tweet"!==C?"quote":"retweet",A.val("tweet"===C?"":"retweet"===C?"//@"+_[2]+": 转发微博":"//@"+_[2]+": "+$.find("p")[0].innerText),A[0].setSelectionRange(0,0)),A.prop("required",!1),x.prop("disabled",!1)}}var E=JSON.parse(localStorage.getItem("profile_"+y))||{},D=angular.element(document.querySelector(".cancelMask__wrapper"));l.item={user:{name:E.displayName,avatar:E.avatar,screen_name:E.screen_name},media:[],text:A.val().trim(),created_at:Date.now(),type:k},"retweet"===k?f():"quote"===k?v():null,p("reply"===b?"tweet":k||b),c.on("submit",function(e){e.preventDefault();var t=A.val().trim(),n={status:t};"twitter"===y?(angular.extend(n,{geo:c.find("geo-picker").find("button").data("geo"),media_ids:c.find("media-upload").find("input").data("media_ids"),sensitive:c.find("toggle-sensitive").find("button").data("sensitive")}),"retweet"===b&&t.length>0&&(n.status=t+" https://twitter.com/"+_[2]+"/status/"+h)):"weibo"===y&&"tweet"===b&&angular.extend(n,{geo:c.find("geo-picker").data("geo")}),A.prop("disabled",!0),x.addClass("write__btn--send--sending"),a.update({action:k||b,provider:y,id:h||0},{params:n}).$promise.then(function(e){if("retweet"===b)if(o.setActionState("retweet",h,"active"),o.actionData("retweet",h,e.id_str),"quote"===k&&"twitter"===y)o.setActionState("retweet",h,"frozen");else{var t=~~o.actionData("retweet",h,null,"count")+1;o.actionData("retweet",h,t,"count")}l.setControlCenter("")})["catch"](function(){x.prop("disabled",!1),A.addClassTemporarily("write__textarea--err",500)})["finally"](function(){A.prop("disabled",!1),x.removeClass("write__btn--send--sending")})}).on("input",function(){var e=A.val().trim(),t="weibo"===y?d(e):e.length;l.item.text=e,g(e),"retweet"===b&&(e.length>0?("retweet"===k&&(v(),p("quote")),k="quote"):("quote"===k&&(f(),p("retweet")),k="retweet")),t>S||0===t&&"retweet"!==b?x.prop("disabled",!0):x.prop("disabled",!1),x.attr("data-count",t>0?t:""),x.addClassTemporarily("write__btn--send--typing",700),w?w.addClassTemporarily("actions__button--"+b+"--active",300):null}).on("$destroy",function(){c.off()})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/geoPicker.html",link:function(t,n,i){var r=n.find("button");r.on("click",function(){r.hasClass("tips--active")?r.removeClass("tips--active tips--inprocess").removeData("geo"):(r.addClass("tips--inprocess"),e.navigator.geolocation.getCurrentPosition(function(e){r.addClass("tips--active").removeClass("tips--inprocess").data("geo",{lat:e.coords.latitude,"long":e.coords.longitude})},function(e){r.removeClass("tips--inprocess").addClassTemporarily("tips--error",500)},{maximumAge:6e4,timeout:7e3}))}).on("$destroy",function(){r.off("click")})}}}]).directive("mediaUpload",["$compile","Media",function(e,t){return{restrict:"E",templateUrl:"controlCenter/write/component/mediaUpload.html",link:function(e,n,i){function r(t,n){var i=new FileReader;i.onload=function(t){var i=URL.createObjectURL(l(t.target.result));e.item.media.push({type:"photo",image_url:i,fakeId:n});var r=angular.element(document.querySelector(".cancelMask__wrapper .timeline__media"));r.length<=0&&(angular.element(document.querySelector(".cancelMask__wrapper .timeline__content")).append('<div class="timeline__media"></div>'),r=angular.element(document.querySelector(".cancelMask__wrapper .timeline__media"))),r.append('<div class="timeline__media--large" data-mediaId="'+n+'"><img src="'+i+'"></div>')},i.readAsDataURL(t)}function a(t){angular.element(document.querySelectorAll('[data-mediaId="'+t+'"]'));e.item.media=e.item.media.filter(function(e){return e.fakeId!==t})}function o(t,i){var r=angular.element(document.querySelectorAll('[data-mediaId="'+t+'"]'));r.removeClass("tips--inprocess").attr("data-mediaId",i).on("click",function(){var t=s.data("media_ids")||[],i=r.attr("data-mediaId"),a=t.indexOf(i);t.splice(a,1),t.length<=0?n.removeData("media_ids"):s.data("media_ids",t),r.remove(),e.item.media.splice(a,1)}).on("$destroy",function(){r.off("click")})}function l(e){var t=";base64,";if(-1==e.indexOf(t)){var n=e.split(","),i=n[0].split(":")[1],r=decodeURIComponent(n[1]);return new Blob([r],{type:i})}for(var n=e.split(t),i=n[0].split(":")[1],r=window.atob(n[1]),a=r.length,o=new Uint8Array(a),l=0;a>l;++l)o[l]=r.charCodeAt(l);return new Blob([o],{type:i})}var c=i.provider,s=n.find("input");s.on("change",function(){var e=new FormData,n=s[0].files[0],i=Date.now();r(n,i),e.append("twitterMedia",n),t.upload({provider:c},e).$promise.then(function(e){var t=s.data("media_ids")||[],n=e.media_id;t.push(n),s.data("media_ids",t),o(i,n)})["catch"](function(e){a(i)}),s[0].value=""}).on("$destroy",function(){s.off("change")})}}}]).directive("toggleSensitive",function(){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/toggleSensitive.html",link:function(e,t,n){var i=t.find("button");i.on("click",function(){i.hasClass("tips--active")?i.removeClass("tips--active").data("sensitive",!1):i.addClass("tips--active").data("sensitive",!0)}).on("$destroy",function(){i.off("click")})}}}).directive("weiboEmotions",function(){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/weiboEmotions.html",controller:["$scope",function(e){e.insertEmotion=function(e){e="["+e+"]";var t=document.querySelector("textarea"),n=t.selectionStart,i=t.selectionEnd,r=n+e.length;n||"0"==n?t.value=t.value.substring(0,n)+e+t.value.substring(i,t.value.length):t.value+=e,angular.element(t).parent().triggerHandler("input"),t.setSelectionRange(r,r),t.focus()}}],link:function(e,t,n){var i=t.find("button"),r="笑cry|微笑|嘻嘻|哈哈|可爱|可怜|挖鼻|吃惊|害羞|挤眼|闭嘴|鄙视|爱你|泪|偷笑|亲亲|生病|太开心|白眼|右哼哼|左哼哼|嘘|衰|委屈|吐|哈欠|抱抱|怒|疑问|馋嘴|拜拜|思考|汗|困|睡|钱|失望|酷|色|哼|鼓掌|晕|悲伤|抓狂|黑线|阴险|怒骂|互粉|心|伤心|猪头|熊猫|兔子|ok|耶|good|NO|赞|来|弱|草泥马|给力|围观|威武|奥特曼|礼物|钟|话筒|蜡烛|蛋糕|带着微博去旅行|最右|泪流满面|江南style|去旅行|doge|喵喵";e.isShowEmotions=!1,e.emotionsList=r.split("|"),i.on("click",function(){i.toggleClass("tips--active"),e.isShowEmotions=!e.isShowEmotions,document.querySelector("textarea").focus()}).on("$destroy",function(){i.off("click")})}}});
angular.module("Oneline.olMediaDirectives",[]).directive("olVideo",function(){return{restrict:"E",scope:{olPoster:"@",olSrc:"@"},templateUrl:"media/video.html",link:function(e,t,i){var n=t.children()[0],r=angular.element(t.children()[1]);n.setAttribute("src",e.olSrc),t.on("click",function(){n.paused?n.play():n.pause(),r.toggleClass("timeline__media__playButton--playing"),t.on("mouseout",function(){n.removeAttribute("loop")})}).on("$destroy",function(){t.off()}),angular.element(n).on("ended",function(){r.removeClass("timeline__media__playButton--playing")})}}}).directive("olImageThumb",function(){return{restrict:"A",link:function(e,t,i){t.on("click",function(){var e=t.parent(),n=e.next(),r=e.children(),a=n.find("img"),l=n.find("a");if(r.removeClass("timeline__media--active").addClass("timeline__media--inactive"),t.addClass("timeline__media--active timeline__media--loading"),e.addClass("timeline__media--small"),n.removeClass("timeline__media--hide"),a.attr("src",i.src.replace(/square|small/,"bmiddle")),l.attr("href",i.src.replace(/square|small/,"large")),a.on("load",function(){1===r.length?t.parent().remove():null,t.removeClass("timeline__media--loading"),a.off("load")}),!a.data("urlList")){var o=Array.prototype.map.call(r,function(e){return angular.element(e).attr("src").replace(/square|small/,"bmiddle")});a.data("urlList",o)}}).on("$destroy",function(){t.off()})}}}).directive("selectImage",function(){return{restrict:"A",link:function(e,t,i){i.imageCount>1&&t.on("mousemove",function(e){e.offsetX-t[0].offsetWidth/2>0?(t.removeClass("cursor--pre"),t.addClass("cursor--next")):(t.removeClass("cursor--next"),t.addClass("cursor--pre"))}).on("click",function(){var e=t.data("urlList")||[],i=e.indexOf(t.attr("src")),n=t.hasClass("cursor--next")?i+1:i-1;if(!(0>n||n>e.length-1)){var r=angular.element(angular.element(t.parent().parent().children()[0]).children()),a=angular.element(r[n]);t.attr("src",e[n]).next().attr("href",e[n].replace("bmiddle","large")),r.removeClass("timeline__media--active timeline__media--loading"),a.addClass("timeline__media--active timeline__media--loading"),t.on("load",function(){a.removeClass("timeline__media--loading"),t.off("load")})}}).on("$destroy",function(){t.off()})}}}).directive("handleImageError",function(){return{restrict:"A",link:function(e,t,i){t.on("error",function(){""!==t.attr("src")&&t.attr("src",'data:image/svg+xml;utf8,<svg viewBox="0 0 529 530" xmlns="http://www.w3.org/2000/svg"><g fill="none"><path d="M51.245 150.775c-3.454-1.729-5.458-.098-4.476 3.638l.706 2.688c8.01 30.498-2.986 73.86-24.566 96.854l-.662.706c-2.643 2.816-1.649 5.288 2.193 5.52l136.636 8.237c9.376.565 23.953-2.031 32.554-5.798l21.279-9.319-13.768-18.801c-5.55-7.579-16.851-17.127-25.254-21.333l-124.642-62.392z" fill="#000"/><path d="M9.298 290.938c13.001 129.203 122.073 230.062 254.702 230.062 141.385 0 256-114.615 256-256s-114.615-256-256-256c-84.794 0-159.96 41.226-206.547 104.728" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/><path d="M361.259 190.733c-4.06-1.129-8.339-1.733-12.759-1.733-26.234 0-47.5 21.266-47.5 47.5 0 4.115.523 8.109 1.507 11.917" stroke="#000" stroke-width="17" stroke-linecap="round"/><path d="M213.468 406.97c13.141-16.776 37.347-28.026 65.032-28.026 30.37 0 56.552 13.538 68.536 33.056" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/></g></svg>')})}}}).directive("olLazyImage",function(){return{restrict:"A",scope:{ratio:"@olLazyImage"},link:function(e,t,i){var n=e.ratio;t.css("padding-bottom",100*n+"%")}}});
