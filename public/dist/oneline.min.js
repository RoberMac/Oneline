...
angular.module("Oneline.maskControllers",[]).controller("maskCtrl",["$scope","$state","$stateParams","Action","store","olMask",function(e,a,t,n,l,i){function o(){e.loadState="initLoad",e.mask={},"user"!==s&&angular.extend(e.mask,{type:s,title:m,q:c}),e.loadMaskTimeline=function(){if("loading"!==e.loadState){var a="user"===s?"user_timeline":d,t=document.querySelectorAll(".mask .timeline"),n=angular.element(t[t.length-1]),l="weibo"===r?n.attr("data-created"):n.attr("data-id");e.loadState="loading",i.loadOldPosts(a,r,c,l).then(function(a){e.mask.timeline=e.mask.timeline.concat(a),e.loadState="loadFin"})["catch"](function(a){e.loadState="loadFail"})}};var a="mask/"+("user"===s?"user":"search")+"/"+r+".html";i.append(a,e),g?f.addClass("timeline__media--loading"):null,n.get({action:d,provider:r,id:u}).$promise.then(function(a){angular.extend(e.mask,"user"===s?a.data:{timeline:a.data}),e.loadState="loadFin",g?f.addClass("timeline__media--active"):null})["catch"](function(){angular.extend(e.mask,{avatar:"/public/img/src/locked.svg","protected":!0}),e.loadState="loadFail",g?f.addClass("tips--frozen"):null})["finally"](function(){g?f.removeClass("timeline__media--loading"):null})}var r=t.provider,s=t.action,d="twitter"===r?"user"===s?"user":"search":s,c=t.id,u="twitter"===r?"tags"===s?"#"+c:"location"===s?"place:"+c:c:c,m=t.x;e.providerList.indexOf(r)<0&&a.go("settings"),console.log("....");var g=e.controlCenter.indexOf("read")>=0;if(g){var f=angular.element(document.querySelector('[data-btn="'+c+'"]'));if(f.hasClass("tips--frozen"))return;o()}else i["switch"](e).then(function(){o()})}]);
angular.module("Oneline.rootControllers",[]).controller("rootController",["$q","$rootScope","$window","$scope","$timeout","$state","olTokenHelper","olUI","timelineCache",function(e,t,n,r,o,i,l,a,c){r.providerList=l.getProviderList(),r.controlCenter="",r.updateProviderList=function(){var e=l.getProviderList();o(function(){r.providerList=e})},r.setControlCenter=function(t,n){function l(e){var t=["replicant","read","write","notification"];return t.map(function(t){return e+t}).join(" ")}var a=e.defer();return""===t&&"timeline.action"===i.current.name&&i.go("timeline"),r.controlCenter=t,n?o(function(){r.setControlCenter(n),a.resolve()},700):a.resolve(),o(function(){var e=angular.element(document.querySelector(".cancelMask__wrapper")),n=angular.element(document.querySelector(".controlCenter")),r=t.match(/replicant|read|write|notification/);r?(e.addClass("cancelMask__wrapper--"+r[0]),n.addClass("controlCenter--"+r[0])):(e.removeClass(l("cancelMask__wrapper--")),n.removeClass(l("controlCenter--")))}),a.promise},r["goto"]=function(e,t){var n=i.current.name;if("left"===e){if(r.providerList<=0)return;"settings"===n?i.go("timeline"):angular.element(document.querySelector("[js-show-menu]")).triggerHandler("click")}else"timeline"===n?r.controlCenter?r.setControlCenter(""):i.go("settings"):null},angular.element(n).on("keydown",function(e){27===e.keyCode&&r.$apply(function(){r.setControlCenter("")})}),t.$on("$stateChangeStart",function(e,t,n,r,o){"timeline"===t.name&&(l.isValidToken()||(e.preventDefault(),i.go("settings")))}),t.$on("$stateChangeSuccess",function(e,t,n,o,i){"settings"===t.name&&(l.isValidToken()||l.clearInvalidToken(),document.title="｜",c.removeAll(),r.updateProviderList(),r.setControlCenter(""))})}]);
