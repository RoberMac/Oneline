...
angular.module("Oneline.maskControllers",[]).controller("maskCtrl",["$scope","$state","$stateParams","Action","store","olMask",function(t,a,e,n,i,l){function o(){t.loadState="initLoad",t.mask={},"user"!==s&&angular.extend(t.mask,{type:s,title:m,q:c}),t.loadMaskTimeline=function(){if("loading"!==t.loadState){var a="user"===s?"user_timeline":d,e=document.querySelectorAll(".mask .timeline"),n=angular.element(e[e.length-1]),i="weibo"===r?n.attr("data-created"):n.attr("data-id");t.loadState="loading",l.loadOldPosts(a,r,c,i).then(function(a){t.mask.timeline=t.mask.timeline.concat(a),t.loadState="loadFin"})["catch"](function(a){t.loadState="loadFail"})}};var a="mask/"+("user"===s?"user":"search")+"/"+r+".html";l.append(a,t),n.get({action:d,provider:r,id:u}).$promise.then(function(a){angular.extend(t.mask,"user"===s?a.data:{timeline:a.data}),t.loadState="loadFin"})["catch"](function(){angular.extend(t.mask,{avatar:"/public/img/src/locked.svg","protected":!0}),t.loadState="loadFail"})["finally"](function(){})}var r=e.provider,s=e.action,d="twitter"===r?"user"===s?"user":"search":s,c=e.id,u="twitter"===r?"tags"===s?"#"+c:"location"===s?"place:"+c:c:c,m=e.x;t.providerList.indexOf(r)<0&&a.go("settings"),l["switch"](t).then(function(){o()})}]);
angular.module("Oneline.rootControllers",[]).controller("rootController",["$q","$rootScope","$window","$scope","$timeout","$state","olTokenHelper","olUI","timelineCache",function(e,t,n,r,o,i,l,a,c){r.providerList=l.getProviderList(),r.controlCenter="",r.updateProviderList=function(){var e=l.getProviderList();o(function(){r.providerList=e})},r.setControlCenter=function(t,n){function l(e){var t=["read","write","notification"];return t.map(function(t){return e+t}).join(" ")}var a=e.defer();return""===t&&"timeline.action"===i.current.name&&i.go("timeline"),r.controlCenter=t,n?o(function(){r.setControlCenter(n),a.resolve()},700):a.resolve(),o(function(){var e=angular.element(document.querySelector(".cancelMask__wrapper")),n=angular.element(document.querySelector(".controlCenter")),r=t.match(/read|write|notification/);r?(e.addClass("cancelMask__wrapper--"+r[0]),n.addClass("controlCenter--"+r[0])):(e.removeClass(l("cancelMask__wrapper--")),n.removeClass(l("controlCenter--")))}),a.promise},r["goto"]=function(e,t){var n=i.current.name;if("left"===e){if(r.providerList<=0)return;"settings"===n?i.go("timeline"):angular.element(document.querySelector("[js-show-menu]")).triggerHandler("click")}else"timeline"===n?r.controlCenter?r.setControlCenter(""):i.go("settings"):null},angular.element(n).on("keydown",function(e){27===e.keyCode&&r.$apply(function(){r.setControlCenter("")})}),t.$on("$stateChangeStart",function(e,t,n,r,o){"timeline"===t.name&&(l.isValidToken()||(e.preventDefault(),i.go("settings")))}),t.$on("$stateChangeSuccess",function(e,t,n,o,i){"settings"===t.name&&(l.isValidToken()||l.clearInvalidToken(),document.title="｜",c.removeAll(),r.updateProviderList(),r.setControlCenter(""))})}]);
