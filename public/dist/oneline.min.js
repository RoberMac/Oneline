...
angular.module("Oneline.rootControllers",[]).controller("rootController",["$rootScope","$scope","$timeout","$state","olTokenHelper","olUI","timelineCache",function(e,t,n,o,i,r,l){t.providerList=i.getProviderList(),t.isTimeline=!1,t.controlCenter="",t.updateProviderList=function(){var e=i.getProviderList();n(function(){t.providerList=e,r.updateSocialIcon(e)})},t.setControlCenter=function(e){t.controlCenter=e},t["goto"]=function(e,n){var i=o.current.name;if("left"===e){if(t.providerList<=0)return;"settings"===i?o.go("timeline"):t.setControlCenter("write_twitter-tweet")}else"timeline"===i?t.controlCenter.indexOf("write")>=0?t.setControlCenter(""):o.go("settings"):null},e.$on("$stateChangeStart",function(e,n,r,l,s){"timeline"===n.name&&(i.isValidToken()?t.isTimeline=!0:(e.preventDefault(),o.go("settings")))}),e.$on("$stateChangeSuccess",function(e,n,o,r,s){"settings"===n.name&&(i.isValidToken()||i.clearInvalidToken(),t.isTimeline=!1),document.title="｜",l.removeAll(),t.updateProviderList(),t.controlCenter=""})}]);
