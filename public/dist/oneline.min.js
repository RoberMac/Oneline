...
angular.module("Oneline.controlCenterDirectives",[]).directive("replicantDeckard",["Replicant","store",function(e,t){return{restrict:"A",link:function(n,i,r){function a(){o=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));i.html(e.substr(0,7))},100);var r=[];n.providerList.forEach(function(e){var n=t.get("profile_"+e);n&&r.push(n)}),e.deckard({profileList:JSON.stringify(r)}).$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(o),i.html(e.code)},700),c=setInterval(function(){return 0>t?(a(),i.attr("data-countdown",""),void clearInterval(c)):void i.attr("data-countdown",t--)},1e3)},function(e){clearInterval(o)})}var o,c;i.on("$destroy",function(){clearInterval(o),clearInterval(c)}),a()}}}]).directive("replicantRachael",["Replicant","olTokenHelper","store",function(e,t,n){return{restrict:"A",link:function(i,r,a){r.on("submit",function(a){a.preventDefault();var o=r.children(),c=o.val();o[0].blur(),e.rachael({code:c}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),i.updateProviderList(),e.profileList.forEach(function(e){n.set("profile_"+e._provider,e)})),i.setControlCenter("")},function(e){o.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("read",[function(){return{restrict:"A",controller:["$scope","Action",function(e,t){var n=e.controlCenter.split(":"),i=n[1],r=n[0].split("-")[0].split("_")[1],a=n[0].split("-")[1];t.get({action:a,provider:r,id:i}).$promise.then(function(t){e.readType=a,e.readItems=t.data})["catch"](function(){angular.element(document.querySelector(".read .loadMore__btn")).addClass("loadMore__btn--loading--fail")})}]}}]).directive("notification",["$compile","$timeout",function(e,t){return{restrict:"A",link:function(n,i,r){function a(i,r){return function(){i.hasClass("notification__column--active")||(i.parent().children().removeClass("notification__column--active"),i.addClass("notification__column--active "),t(function(){var t=angular.element(document.querySelector(".cancelMask__wrapper")),i="<"+r+' provider="'+o+'"></'+r+">";t.children().empty().append(e(i)(n))}))}}var o=r.notification,c=angular.element(i.find("button")[0]),l=angular.element(i.find("button")[1]);a(c,"mentions")(),c.on("click",a(c,"mentions")).on("$destroy",function(){c.off()}),l.on("click",a(l,"direct")).on("$destroy",function(){l.off()})}}}]).directive("write",["$filter","Action","olUI","olWrite","store",function(e,t,n,i,r){return{restrict:"A",scope:!1,controller:["$scope",function(e){var t={twitter:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/,instagram:/(|\s)*@([\w\.]*)$/,weibo:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/};e.insertMention=function(e,n){i.removeText(t[n]),i.insertText(e.trim()+" ")}}],link:function(a,o,c){var l,s=a.controlCenter.split(":"),d=s[1],u=s[0].split("-")[0].split("_")[1],p=s[0].split("-")[1],m="",f=s[0].split("-")[2],v="tweet"===p||"reply"===p||"weibo"===u?140:"retweet"===p?116:null,w=o.find("button"),g=w.eq(w.length-1),_=o.find("textarea");if(_[0].focus(),"tweet"!==p){var h=document.querySelector('[data-id="'+d+'"]'),y=angular.element(h);switch(p){case"reply":"twitter"===u&&_.val(i.extractMentions(y.find("p")[0].innerText,"@"+s[2]));break;case"retweet":m="retweet","weibo"===u&&(m="tweet"!==f?"quote":"retweet",_.val("tweet"===f?"":"retweet"===f?"//@"+s[2]+": 转发微博":"//@"+s[2]+": "+y.find("p")[0].innerText),_[0].setSelectionRange(0,0)),_.prop("required",!1),g.prop("disabled",!1)}}var b=r.get("profile_"+u)||{},C=r.get("mentions_"+u)||[],k={twitter:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/,instagram:/(|\s)*@([\w\.]*)$/,weibo:/(|\s)*@([\u4e00-\u9fa5\w-]*)$/};a.isShowMentions=!1,a.mentionsList=C,a.item={user:{name:b.name,avatar:b.avatar,screen_name:b.screen_name},media:[],text:_.val().trim(),created_at:Date.now(),type:m},"retweet"===m?angular.extend(a.item,i.generateRetweetUser(d,f,u)):"quote"===m?angular.extend(a.item,i.generateQuoteUser(d,f,u)):null,i.generateTemplate("reply"===p?"tweet":m||p,a,u),o.on("submit",function(e){e.preventDefault();var i=_.val().trim(),r={status:i};"twitter"===u?(angular.extend(r,{geo:o.find("geo-picker").find("button").data("geo"),media_ids:o.find("media-upload").find("input").data("media_ids"),sensitive:o.find("toggle-sensitive").find("button").data("sensitive")}),"retweet"===p&&i.length>0&&(r.status=i+" https://twitter.com/"+s[2]+"/status/"+d)):"weibo"===u&&"tweet"===p&&angular.extend(r,{geo:o.find("geo-picker").data("geo")}),_.prop("disabled",!0),g.addClass("write__btn--send--sending"),t.update({action:m||p,provider:u,id:d||0},{params:r}).$promise.then(function(e){if("retweet"===p)if(n.setActionState("retweet",d,"active"),n.actionData("retweet",d,e.id_str),"quote"===m&&"twitter"===u)n.setActionState("retweet",d,"frozen");else{var t=~~n.actionData("retweet",d,null,"count")+1;n.actionData("retweet",d,t,"count")}a.setControlCenter("")})["catch"](function(){g.prop("disabled",!1),_.addClassTemporarily("write__textarea--err",500)})["finally"](function(){_.prop("disabled",!1),g.removeClass("write__btn--send--sending")})}).on("input",function(){var t=_.val(),n=t.trim().length>0?t:t.trim(),r="weibo"===u?i.weiboLength(n):n.length,o=n.match(k[u]);if(o){var c=e("limitTo")(e("filter")(C,"twitter"===u?{$:o[2].trim()}:o[2].trim()),100);c.length>0?(a.isShowMentions=!0,a.mentionsList=c):a.isShowMentions=!1}else a.isShowMentions&&(a.isShowMentions=!1);a.item.text=n,i.refreshPreviewText(n,u),"retweet"===p&&(n.length>0?("retweet"===m&&(angular.extend(a.item,i.generateQuoteUser(d,f,u)),i.generateTemplate("quote",a,u)),m="quote"):("quote"===m&&(angular.extend(a.item,i.generateRetweetUser(d,f,u)),i.generateTemplate("retweet",a,u)),m="retweet")),r>v||0===r&&"retweet"!==p?g.prop("disabled",!0):g.prop("disabled",!1),g.attr("data-count",r>0?r:""),g.addClassTemporarily("write__btn--send--typing",700),l?l.addClassTemporarily("actions__button--"+p+"--active",300):null}).on("$destroy",function(){o.off()})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/geoPicker.html",link:function(t,n,i){var r=n.find("button");r.on("click",function(){r.hasClass("tips--active--peace")?r.removeClass("tips--active--peace tips--inprocess").removeData("geo"):(r.addClass("tips--inprocess"),e.navigator.geolocation.getCurrentPosition(function(e){r.addClass("tips--active--peace").removeClass("tips--inprocess").data("geo",{lat:e.coords.latitude,"long":e.coords.longitude})},function(e){r.removeClass("tips--inprocess").addClassTemporarily("tips--error",500)},{maximumAge:6e4,timeout:7e3}))}).on("$destroy",function(){r.off("click")})}}}]).directive("mediaUpload",["Media",function(e){return{restrict:"E",templateUrl:"controlCenter/write/component/mediaUpload.html",link:function(t,n,i){function r(e,n){var i=new FileReader,r=new Image;i.onload=function(e){var i=URL.createObjectURL(c(e.target.result));r.src=i,r.onload=function(){var e=(r.height/r.width).toFixed(5),t=angular.element(document.querySelector(".cancelMask__wrapper .timeline__media"));t.length<=0&&(angular.element(document.querySelector(".cancelMask__wrapper .timeline__content")).append('<div class="timeline__media"></div>'),t=angular.element(document.querySelector(".cancelMask__wrapper .timeline__media"))),t.append('<div class="timeline__media--large" data-mediaId="'+n+'" data-ratio="'+e+'"><img src="'+i+'"></div>')},t.item.media.push({type:"photo",image_url:i,fakeId:n}),t.$apply()},i.readAsDataURL(e)}function a(e){angular.element(document.querySelectorAll('[data-mediaId="'+e+'"]'));t.item.media=t.item.media.filter(function(t){return t.fakeId!==e}),t.$apply()}function o(e,i){var r=angular.element(document.querySelectorAll('[data-mediaId="'+e+'"]'));angular.element(r[0]).css("padding-bottom",100*r.attr("data-ratio")+"%"),r.removeClass("tips--inprocess").attr("data-mediaId",i).on("click",function(){var e=s.data("media_ids")||[],i=r.attr("data-mediaId"),a=e.indexOf(i);e.splice(a,1),e.length<=0?n.removeData("media_ids"):s.data("media_ids",e),r.remove(),t.item.media.splice(a,1),t.$apply()}).on("$destroy",function(){r.off("click")})}function c(e){var t=";base64,";if(-1==e.indexOf(t)){var n=e.split(","),i=n[0].split(":")[1],r=decodeURIComponent(n[1]);return new Blob([r],{type:i})}for(var n=e.split(t),i=n[0].split(":")[1],r=window.atob(n[1]),a=r.length,o=new Uint8Array(a),c=0;a>c;++c)o[c]=r.charCodeAt(c);return new Blob([o],{type:i})}var l=i.provider,s=n.find("input");s.on("change",function(){var t=new FormData,n=s[0].files[0];document.querySelector(".write__previews__item")||s.data("media_ids",[]);var i=Date.now();r(n,i),t.append("twitterMedia",n),e.upload({provider:l},t).$promise.then(function(e){var t=s.data("media_ids")||[],n=e.media_id;t.push(n),s.data("media_ids",t),o(i,n)})["catch"](function(e){a(i)}),s[0].value=""}).on("$destroy",function(){s.off("change")})}}}]).directive("toggleSensitive",function(){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/toggleSensitive.html",link:function(e,t,n){var i=t.find("button");i.on("click",function(){i.hasClass("tips--active--peace")?i.removeClass("tips--active--peace").data("sensitive",!1):i.addClass("tips--active--peace").data("sensitive",!0)}).on("$destroy",function(){i.off("click")})}}}).directive("weiboEmotions",["olWrite",function(e){return{restrict:"E",scope:{},templateUrl:"controlCenter/write/component/weiboEmotions.html",controller:["$scope",function(t){t.insertEmotion=function(t){t="["+t+"]",e.insertText(t)}}],link:function(e,t,n){var i=t.find("button"),r="笑cry|微笑|嘻嘻|哈哈|可爱|可怜|挖鼻|吃惊|害羞|挤眼|闭嘴|鄙视|爱你|泪|偷笑|亲亲|生病|太开心|白眼|右哼哼|左哼哼|嘘|衰|委屈|吐|哈欠|抱抱|怒|疑问|馋嘴|拜拜|思考|汗|困|睡|钱|失望|酷|色|哼|鼓掌|晕|悲伤|抓狂|黑线|阴险|怒骂|互粉|心|伤心|猪头|熊猫|兔子|ok|耶|good|NO|赞|来|弱|草泥马|给力|围观|威武|奥特曼|礼物|钟|话筒|蜡烛|蛋糕|带着微博去旅行|最右|泪流满面|江南style|去旅行|doge|喵喵";e.isShowEmotions=!1,e.emotionsList=r.split("|"),i.on("click",function(){i.toggleClass("tips--active--peace"),e.$apply(function(){e.isShowEmotions=!e.isShowEmotions}),document.querySelector("textarea").focus()}).on("$destroy",function(){i.off("click")})}}}]);
angular.module("Oneline.maskDirectives",[]).directive("userProfile",["$timeout","$compile","$templateRequest","Action","store",function(e,t,n,o,i){return{restrict:"A",scope:{profile:"=userProfile"},link:function(r,a,l){a.on("click",function(){var c=l.provider,s=r.profile||i.get("profile_"+c),d=l.from,u=s.uid;"controlCenter"===d&&a.hasClass("tips--frozen")||(r.user={screen_name:s.screen_name,avatar:s.avatar,name:s.name,uid:u},e(function(){var e=angular.element(document.querySelector(".cancelMask__wrapper"));n("mask/user/"+c+".html").then(function(n){e.children().empty().append(t(n)(r))})}),"controlCenter"===d?a.addClass("timeline__media--loading"):null,o.get({action:"user",provider:c,id:u}).$promise.then(function(e){angular.extend(r.user,e.data),"controlCenter"===d?a.addClass("timeline__media--active"):null})["catch"](function(){r.user["protected"]=!0,"controlCenter"===d?a.addClass("tips--frozen"):null})["finally"](function(){"controlCenter"===d?a.removeClass("timeline__media--loading"):null}))}),a.on("$destroy",function(){a.off("click")})}}}]).directive("toggleFollowing",["Action",function(e){return{restrict:"A",link:function(t,n,o){n.on("click",function(){var t=angular.element(document.querySelectorAll(".profile__count__column")[1]),i=o.toggleFollowing.split(":"),r=i[0],a=i[1],l=n.hasClass("icon--"+r);n.addClass("tips--inprocess"),e[l?"destroy":"create"]({action:"follow",provider:r,id:a}).$promise.then(function(e){n.toggleClass("tips--active icon--"+r);var o=~~t.attr("data-count")+(l?-1:1);t.attr("data-count",o)})["catch"](function(e){n.addClassTemporarily("tips--error",500)})["finally"](function(){n.removeClass("tips--inprocess")})})}}}]).directive("mentions",["$timeout","olNotification",function(e,t){return{restrict:"E",scope:{},templateUrl:"mask/notification/mentions/twitter.html",controller:["$scope","$element",function(n,o){var i,r=o.attr("provider");n.notifications=[],i=t.initLoad(r,"mentions"),i&&i.length>0?e(function(){n.notifications=i,angular.element(document.querySelectorAll("[js-load-mentions]")).removeClass("loadMore__btn--loading").parent().removeClass("loadMore--initLoad")},700):t.load().then(function(e){n.notifications=e}),n.loadMentions=function(e){var o=angular.element(document.querySelector('[js-load-mentions="'+e+'"]'));o.hasClass("loadMore__btn--loading")||t.load(e,o).then(function(e){n.notifications=e})}}]}}]).directive("direct",["$timeout","$filter","olNotification",function(e,t,n){return{restrict:"E",scope:{},templateUrl:"mask/notification/direct/twitter.html",controller:["$scope","$element","store",function(o,i,r){function a(e){l=e,o.senderList=n.extractSenders(e,s)}var l,c=i.attr("provider"),s=r.get("profile_"+c).uid;o.notifications=[],o.senderList=[],o._uid=s,l=n.initLoad(c,"direct"),l&&l.length>0?e(function(){a(l),angular.element(document.querySelectorAll("[js-load-direct]")).removeClass("loadMore__btn--loading").parent().removeClass("loadMore--initLoad")},700):n.load().then(function(e){a(e)}),o.loadDirect=function(e){var t=angular.element(document.querySelector('[js-load-direct="'+e+'"]'));t.hasClass("loadMore__btn--loading")||n.load(e,t).then(function(e){a(e)})},o.showDirect=function(e){var n=angular.element(document.querySelector('[js-direct-sender="'+e+'"]'));o.notifications=t("filter")(l,function(t,n,o){return t.sender.uid===e||t.sender.uid===s&&t.recipient.uid===e}),n.parent().children().removeClass("tips--active--peace"),n.addClass("tips--active--peace")}}]}}]);
...
angular.module("Oneline.rootControllers",[]).controller("rootController",["$rootScope","$window","$scope","$timeout","$state","olTokenHelper","olUI","timelineCache",function(e,t,n,o,r,i,l,a){n.providerList=i.getProviderList(),n.isTimeline=!1,n.controlCenter="",n.updateProviderList=function(){var e=i.getProviderList();o(function(){n.providerList=e,l.updateSocialIcon(e)})},n.setControlCenter=function(e,t){function r(e){var t=["replicant","read","write","notification","userProfile"];return t.map(function(t){return e+t}).join(" ")}n.controlCenter=e,t&&o(function(){n.setControlCenter(t)},700),o(function(){var t=angular.element(document.querySelector(".cancelMask__wrapper")),n=angular.element(document.querySelector(".controlCenter")),o=e.match(/replicant|read|write|notification|userProfile/);o?(t.addClass("cancelMask__wrapper--"+o[0]),n.addClass("controlCenter--"+o[0])):(t.removeClass(r("cancelMask__wrapper--")),n.removeClass(r("controlCenter--")))})},n["goto"]=function(e,t){var o=r.current.name;if("left"===e){if(n.providerList<=0)return;"settings"===o?r.go("timeline"):n.providerList.indexOf("twitter")>=0?n.setControlCenter("write_twitter-tweet"):n.providerList.indexOf("weibo")>=0?n.setControlCenter("write_weibo-tweet"):null}else"timeline"===o?n.controlCenter?n.setControlCenter(""):r.go("settings"):null},angular.element(t).on("keydown",function(e){27===e.keyCode&&n.$apply(function(){n.setControlCenter("")})}),e.$on("$stateChangeStart",function(e,t,o,l,a){"timeline"===t.name&&(i.isValidToken()?n.isTimeline=!0:(e.preventDefault(),r.go("settings")))}),e.$on("$stateChangeSuccess",function(e,t,o,r,l){"settings"===t.name&&(i.isValidToken()||i.clearInvalidToken(),n.isTimeline=!1),document.title="｜",a.removeAll(),n.updateProviderList(),n.setControlCenter("")})}]);
