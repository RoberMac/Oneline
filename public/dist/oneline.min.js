...
angular.module("Oneline.maskServices",[]).service("olUserProfile",["$q","Action",function(e,t){this.loadOldPosts=function(i,n){var r=e.defer(),o=document.querySelectorAll(".profile .timeline"),a=angular.element(o[o.length-1]).attr("data-id");return t.get({action:"user_timeline",provider:i,id:n,max_id:a}).$promise.then(function(e){r.resolve(e.data.data)})["catch"](function(e){r.reject(e)}),r.promise}}]).service("olNotification",["$q","$filter","store","Action",function(e,t,i,n){function r(e,i){return t("orderBy")(t("filter")(c,function(t,n,r){return t.sender.uid===e||t.sender.uid===i&&t.recipient.uid===e}),"created_at")}var o,a,d,c,u;this.initLoad=function(e,t){return o=e,a=t,d="mentions"===t?"notification_m_"+e:"notification_d_"+e,_info=i.get(d)||{},c=_info.notifications||[],u=_info.max_id,c},this.load=function(t){var r=e.defer();return n.get({action:a,provider:o,id:0,min_id:t?null:u}).$promise.then(function(e){e=e.data,u=e.max_id||u,e.data.length>0&&(c=c.concat(e.data),i.set(d,{notifications:c,max_id:u})),r.resolve(c)})["catch"](function(e){r.reject(e)}),r.promise},this.extractDirect=function(e){for(var t=[],i={},n=[],o=0,a=c.length;a>o;o++){var d=c[o].sender;d.uid!==e&&n.indexOf(d.uid)<0&&(t.push(c[o].sender),n.push(d.uid))}if(1===t.length){var u=t[0].uid;i[u]=r(u,e)}else t=t.sort(function(t,n){var o=t.uid,a=n.uid,d=r(o,e),c=r(a,e);i[o]=d,i[a]=c;var u=d[d.length-1].created_at;return latestCreatedAt2=c[c.length-1].created_at,u<latestCreatedAt2});return[t,i]}}]);
